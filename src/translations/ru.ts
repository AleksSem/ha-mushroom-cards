const ru: Record<string, string> = {
  ...
  'editor.show_power': 'Мощность',
  'editor.show_daily_consumption': 'За день',
  'editor.show_monthly_consumption': 'За месяц',
  'editor.show_yearly_consumption': 'За год',
  ...
  'editor.power_on_behavior': 'Поведение при включении',
