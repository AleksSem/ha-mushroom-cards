...
`];function wt(t,e){if(!t.entities)return[];const i=t.entities[e];if(!i?.device_id)return[];const s=i.device_id;return Object.values(t.entities).filter(t=>t.device_id===s).map(t=>t.entity_id)}function xt(t,e,i,s){const o=i.endsWith(".")?i:i+".",n=e.filter(e=>e.startsWith(o)&&t.states[e]);if(0===n.length)return;if(!s)return n[0];const{deviceClass:r,keywords:a}=s,c=e=>!!r&&t.states[e]?.attributes.device_class===r,l=t=>!(!a||0===a.length)&&a.some(e=>t.includes(e)),d=n.find(t=>c(t)&&l(t));if(d)return d;const h=n.find(t=>c(t));if(h)return h;const u=n.find(t=>l(t));return u||void 0}function kt(t){return t.attributes.preset_mode}function Ct(t,e){const i=function(t,e){if(!e)return;const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:void 0}(t,e);if(void 0===i)return;const s=parseFloat(i);return isNaN(s)?void 0:s}function St(t){const e=window;e.customCards=e.customCards||[],e.customCards.some(e=>e.type===t.type)||e.customCards.push(t)}function Et(t,e,i,s,o){t.callService(e,i,{entity_id:s,...o})}function At(t,e){Et(t,e.split(".")[0],"toggle",e)}function Ot(t,e,i){Et(t,e.split(".")[0],"turn_on",e,i)}function zt(t,e,i,s,o){if(0===i.length)return q;const n=i=>{o||Ot(t,e),function(t,e,i){Et(t,"fan","set_preset_mode",e,{preset_mode:i})}(t,e,i)};return K`
  ...
  `,t([ut({attribute:!1})],Ht.prototype,"schedule",void 0),t([ut({type:Boolean})],Ht.prototype,"compact",void 0),t([pt()],Ht.prototype,"_remaining",void 0),Ht=t([lt("hac-timer-badge")],Ht);const Nt=["timer.day_mon","timer.day_tue","timer.day_wed","timer.day_thu","timer.day_fri","timer.day_sat","timer.day_sun"];let jt=class extends at{constructor(){super(...arguments),this.entityId="",this.entityName="",this.open=!1,this.defaultAction="turn_off",this._schedules=[]}get _primaryEntityId(){return Array.isArray(this.entityId)?this.entityId[0]:this.entityId}connectedCallback(){super.connectedCallback(),this._unsubscribe=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._primaryEntityId)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}updated(t){t.has("hass")&&this.hass&&Pt.connect(this.hass),t.has("entityId")&&(this._schedules=Pt.getSchedulesForEntity(this._primaryEntityId))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!0,composed:!0}))}async _onTimerStart(t){const e=Array.isArray(this.entityId)&&this.entityId.length>1?function(t,e){const i=t[0].split(".")[0],s={target_entity:t[0],action:"custom",service:`${i}.${e.action}`,service_data:{entity_id:t}};return e.duration?s.duration=e.duration:e.time&&(s.time=e.time),e.days_of_week?.length&&(s.days_of_week=e.days_of_week),s}(this.entityId,t.detail):Tt(this._primaryEntityId,t.detail);await Pt.createSchedule(this.hass,e)}async _cancelSchedule(t){await Pt.cancelSchedule(this.hass,t)}render(){if(!this.open)return q;const t=this.hass?.language||"en";return K`
        ...
        ${e.map(e=>K`
            <div class="active-item">
              ...
              <span class="recurring-info">
                ${e.days_of_week?function(t,e){return t.map(t=>mt(Nt[t],e)).join(", ")}(e.days_of_week,t):""}
    ...
    `}};function Rt(t,e){const i=t.length>0,s=t.filter(t=>!t.recurring);return K`
    <div class="timer-control">
      <button class="timer-btn ${i?"active":""}" @click=${e}>
        <ha-icon icon="mdi:timer-outline"></ha-icon>
      </button>
      ${s.length>0?s.map(t=>K`<hac-timer-badge .schedule=${t} compact></hac-timer-badge>`):q}
    </div>
  `}function Ft(t,e,i,s,o,n){return K`
    <hac-timer-dialog
      .hass=${t}
      .entityId=${e}
      .entityName=${i}
  ...
  `,t([ut({attribute:!1})],jt.prototype,"hass",void 0),t([ut({attribute:!1})],jt.prototype,"entityId",void 0),t([ut()],jt.prototype,"entityName",void 0),t([ut({type:Boolean})],jt.prototype,"open",void 0),t([ut()],jt.prototype,"defaultAction",void 0),t([pt()],jt.prototype,"_schedules",void 0),jt=t([lt("hac-timer-dialog")],jt);const Kt=r`
  @keyframes spin {
...
`;let Bt=class extends at{constructor(){super(...arguments),this.icon="mdi:air-purifier",this.active=!1,this.animated=!0,this.animation="spin"}render(){const t=this.active&&this.animated?this.animation:"";return K`
  ...
  `],t([ut()],Bt.prototype,"icon",void 0),t([ut({type:Boolean})],Bt.prototype,"active",void 0),t([ut({type:Boolean})],Bt.prototype,"animated",void 0),t([ut()],Bt.prototype,"animation",void 0),Bt=t([lt("hac-shape-icon")],Bt);let qt=class extends at{constructor(){super(...arguments),this.primary="",this.secondary=""}render(){return K`
  ...
  `,t([ut()],qt.prototype,"primary",void 0),t([ut()],qt.prototype,"secondary",void 0),qt=t([lt("hac-state-info")],qt);let Wt=class extends at{render(){return K`
      <div class="container">
        <slot name="icon"></slot>
        <slot name="info"></slot>
      </div>
  ...
  `,Wt=t([lt("hac-state-item")],Wt);let Vt=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){const t=(this.value-this.min)/(this.max-this.min)*100;return K`
  ...
  `,t([ut({type:Number})],Yt.prototype,"value",void 0),t([ut()],Yt.prototype,"color",void 0),Yt=t([lt("hac-progress-bar")],Yt);let Gt=class extends at{constructor(){super(...arguments),this.icon="",this.active=!1,this.label=""}_handleClick(){this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}render(){return K`
      <button
  ...
  `,t([ut()],Gt.prototype,"icon",void 0),t([ut({type:Boolean})],Gt.prototype,"active",void 0),t([ut()],Gt.prototype,"label",void 0),Gt=t([lt("hac-toggle-button")],Gt);const Jt=r`
  :host {
    display: block;
    --ha-space-6: 4px;
  }
...
`;function Xt(t,e){const i=t?.language||"en";return mt(`editor.${e.name}`,i)||e.name}function Zt(t,e){t.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const Qt=[{name:"entity",required:!0,selector:{entity:{domain:"fan"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_toolbar",selector:{boolean:{}}},{name:"show_stats",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_filter_info",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],te=[{name:"pm25_entity",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"motor_speed_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_life_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_used_time_entity",selector:{entity:{domain:"sensor"}}},{name:"favorite_level_entity",selector:{entity:{domain:"number"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"led_entity",selector:{entity:{}}},{name:"buzzer_entity",selector:{entity:{domain:"switch"}}}];let ee=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Xt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}_overrideValueChanged(t){Zt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_toolbar:!0,show_stats:!0,show_settings:!0,show_filter_info:!0,compact_view:!1,icon_animation:!0,...this._config};return K`
  ...
  `}(this.hass,e.childLock,e.led,e.buzzer,a)}
        ...
        ${this._config.show_timer?Ft(this.hass,this._config.entity,s,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
  ...
  `}(this.hass,this._config.entity,e,!1!==this._config.icon_animation)}
        ${!1!==this._config.show_name||!1!==this._config.show_state?K`
            ...
            ></hac-state-info>
          `:q}
        ${this._config.show_timer?Rt(this._schedules,()=>{this._timerDialogOpen=!0}):q}
      </div>
    `}};ie.styles=[gt,$t],t([ut({attribute:!1})],ie.prototype,"hass",void 0),t([pt()],ie.prototype,"_config",void 0),t([pt()],ie.prototype,"_timerDialogOpen",void 0),t([pt()],ie.prototype,"_schedules",void 0),ie=t([lt(ft)],ie);const se="hac-light-card",oe="hac-light-card-editor",ne=[vt,bt,r`
  /* Header */
  .header {
    display: flex;
    align-items: center;
...
`];function re(t){return t.attributes.supported_color_modes||[]}function ae(t){return"on"===t.state}function ce(t){const e=t.attributes.brightness;return null==e?ae(t)?100:0:Math.max(1,Math.round(e/255*100))}function le(t){const e=t/100;let i,s,o;return i=e<=66?255:329.698727446*Math.pow(e-60,-.1332047592),s=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*Math.pow(e-60,-.0755148492),o=e>=66?255:e<=19?0:138.5177312231*Math.log(e-10)-305.0447927307,[Math.round(Math.min(255,Math.max(0,i))),Math.round(Math.min(255,Math.max(0,s))),Math.round(Math.min(255,Math.max(0,o)))]}function de(t,e,i,s,o,n){const r=n&&s?function(t){if(!ae(t))return;const e=function(t){return t.attributes.rgb_color}(t);if(e)return`rgb(${e[0]}, ${e[1]}, ${e[2]})`;const i=t.attributes.color_temp_kelvin;if(i){const[t,e,s]=le(i);return`rgb(${t}, ${e}, ${s})`}}(i):void 0;return K`
    <hac-shape-icon
      icon="mdi:lightbulb"
      ?active=${s}
      .animated=${o}
      ...
      @click=${()=>At(t,e)}
    ></hac-shape-icon>
  `}function he(t,e,i,s,o){const n=function(t,e){const i=[];for(let s=0;s<=5;s++){const o=t+s/5*(e-t),[n,r,a]=le(o);i.push(`rgb(${n}, ${r}, ${a})`)}return`linear-gradient(to right, ${i.join(", ")})`}(s,o);return K`
  ...
  `}let pe=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.gradient=""}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){return K`
      <div class="slider-container">
        <input
          type="range"
          .value=${String(this.value)}
  ...
  `,t([ut({type:Number})],pe.prototype,"value",void 0),t([ut({type:Number})],pe.prototype,"min",void 0),t([ut({type:Number})],pe.prototype,"max",void 0),t([ut({type:Number})],pe.prototype,"step",void 0),t([ut({type:Boolean})],pe.prototype,"disabled",void 0),t([ut()],pe.prototype,"gradient",void 0),pe=t([lt("hac-gradient-slider")],pe);const _e=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_brightness_control",selector:{boolean:{}}},{name:"show_color_temp_control",selector:{boolean:{}}},{name:"show_color_control",selector:{boolean:{}}},{name:"use_light_color",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"hide_controls_when_off",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let me=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Xt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}render(){if(!this.hass||!this._config)return q;const t={show_name:!0,show_state:!0,show_brightness_control:!0,show_color_temp_control:!0,show_color_control:!0,use_light_color:!0,icon_animation:!0,compact_view:!1,hide_controls_when_off:!0,...this._config};return K`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${_e}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}};me.styles=Jt,t([ut({attribute:!1})],me.prototype,"hass",void 0),t([pt()],me.prototype,"_config",void 0),me=t([lt(oe)],me),St({type:se,name:"Light Card",description:"Custom card for light entities with brightness and color controls"});let ge=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}static getConfigElement(){return document.createElement(oe)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("light."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?1:3}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return q;const t=this.hass.states[this._config.entity];if(!t)return K`
        <ha-card>
          <div class="not-found">Entity not found: ${this._config.entity}</div>
        </ha-card>
      `;const e=ae(t),i=this._config.name||t.attributes.friendly_name||"Light",s=this._lang,o=this._config.compact_view;return K`
      <ha-card>
        <div class="container">
          ${this._renderHeader(t,e,i,s)}
          ${o||!e&&!1!==this._config.hide_controls_when_off?q:this._renderControls(t)}
        </div>
        ${this._config.show_timer?Ft(this.hass,this._config.entity,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),n=e?ce(t):0,r=e&&n?`${o} · ${n}%`:o;return K`
      <div class="header">
        ${de(this.hass,this._config.entity,t,e,!1!==this._config.icon_animation,!1!==this._config.use_light_color)}
        ${!1!==this._config.show_name||!1!==this._config.show_state?K`
            <hac-state-info
              .primary=${!1!==this._config.show_name?i:""}
              .secondary=${!1!==this._config.show_state?r:""}
    ...
    `}_renderControls(t){const e=this._config.entity;return K`
      ${!1!==this._config.show_brightness_control&&function(t){const e=re(t);return e.length>0&&!e.every(t=>"onoff"===t)}(t)?function(t,e,i){return K`
    <div class="control-row">
  ...
  `}(this.hass,e,ce(t)):q}
      ${!1!==this._config.show_color_temp_control&&function(t){return re(t).includes("color_temp")}(t)?this._renderColorTemp(t,e):q}
      ${!1!==this._config.show_color_control&&function(t){const e=["hs","xy","rgb","rgbw","rgbww"];return re(t).some(t=>e.includes(t))}(t)?ue(this.hass,e,function(t){return t.attributes.hs_color}(t)?.[0]??0):q}
    `}_renderColorTemp(t,e){const{min:i,max:s}=function(t){return{min:t.attributes.min_color_temp_kelvin??2e3,max:t.attributes.max_color_temp_kelvin??6500}}(t);return he(this.hass,e,function(t){return t.attributes.color_temp_kelvin??4e3}(t),i,s)}};ge.styles=[gt,ne],t([ut({attribute:!1})],ge.prototype,"hass",void 0),t([pt()],ge.prototype,"_config",void 0),t([pt()],ge.prototype,"_timerDialogOpen",void 0),t([pt()],ge.prototype,"_schedules",void 0),ge=t([lt(se)],ge);const fe="hac-plug-card",ye="hac-plug-card-editor",ve=[vt,bt,r`
  /* Header */
  .header {
    display: flex;
    align-items: center;
...
`];function be(t,e){const i=wt(t,e.entity);return{power:e.power_entity||xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:e.daily_consumption_entity||xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:e.monthly_consumption_entity||xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:e.yearly_consumption_entity||xt(t,i,"sensor",{keywords:["yearly"]}),childLock:e.child_lock_entity||xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:e.power_on_behavior_entity||xt(t,i,"select",{keywords:["power_on"]})}}function $e(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}const we=[{name:"entity",required:!0,selector:{entity:{domain:"switch"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_power",selector:{boolean:{}}},{name:"show_daily_consumption",selector:{boolean:{}}},{name:"show_monthly_consumption",selector:{boolean:{}}},{name:"show_yearly_consumption",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],xe=[{name:"power_entity",selector:{entity:{domain:"sensor"}}},{name:"daily_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"monthly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"yearly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"power_on_behavior_entity",selector:{entity:{domain:"select"}}}];let ke=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Xt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}_overrideValueChanged(t){Zt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}_powerOnBehaviorChanged(t){const e=t.target,i=this._resolvedEntities.powerOnBehavior;i&&e.value&&this.hass.callService("select","select_option",{entity_id:i,option:e.value})}_childLockChanged(){const t=this._resolvedEntities.childLock;t&&this.hass.callService("switch","toggle",{entity_id:t})}get _resolvedEntities(){return be(this.hass,this._config)}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_power:!0,show_daily_consumption:!0,show_monthly_consumption:!0,show_yearly_consumption:!0,show_settings:!0,compact_view:!1,icon_animation:!0,...this._config},i=this._resolvedEntities,s=i.childLock,o=!!s&&"on"===this.hass.states[s]?.state,n=i.powerOnBehavior,r=n?this.hass.states[n]:void 0,a=r?.attributes.options||[],c=r?.state;return K`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${we}
  ...
  `],t([ut({attribute:!1})],ke.prototype,"hass",void 0),t([pt()],ke.prototype,"_config",void 0),t([pt()],ke.prototype,"_expandedOverrides",void 0),ke=t([lt(ye)],ke),St({type:fe,name:"Plug Card",description:"Custom card for smart plug/socket entities"});let Ce=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(ye)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("switch."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?2:4}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;if(e.states[i]!==this.hass.states[i])return!0;const s=this._getResolved();for(const t of Object.values(s))if(t&&e.states[t]!==this.hass.states[t])return!0;return!1}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}_getResolved(){return this._resolved&&this._lastEntity===this._config.entity||(this._lastEntity=this._config.entity,this._resolved=be(this.hass,this._config)),this._resolved}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return q;const t=this.hass.states[this._config.entity];if(!t)return K`
        <ha-card>
          <div class="not-found">Entity not found: ${this._config.entity}</div>
        </ha-card>
      ...
      <ha-card>
        <div class="container">
          ...
          ${n?q:function(t,e,i,s){const o=[{entityId:e.power,labelKey:"stats.power",configKey:"show_power"},{entityId:e.dailyConsumption,labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{entityId:e.monthlyConsumption,labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{entityId:e.yearlyConsumption,labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(e=>!1!==s[e.configKey]&&(!!e.entityId&&void 0!==$e(t,e.entityId)));return 0===o.length?q:K`
    <div class="stats-grid">
      ${o.map(e=>{const s=$e(t,e.entityId),o=function(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}(t,e.entityId),n=void 0!==s?void 0!==e.decimals?s.toFixed(e.decimals):Math.round(s).toString():"—";return K`
          <div class="stat-item">
            <span class="stat-value">
              ${n}
  ...
  `}(this.hass,e.childLock,o)}
    ...
    `}_renderHeader(t,e,i,s,o){const n=mt(e?"state.on":"state.off",s),r=e?$e(this.hass,o.power):void 0,a=e&&void 0!==r?`${n} · ${Math.round(r)} W`:n;return K`
      <div class="header">
        ${function(t,e,i,s){return K`
    <hac-shape-icon
      icon="mdi:power-plug"
  ...
  `}(this.hass,this._config.entity,e,!1!==this._config.icon_animation)}
    ...
    `}};Ce.styles=[gt,ve],t([ut({attribute:!1})],Ce.prototype,"hass",void 0),t([pt()],Ce.prototype,"_config",void 0),t([pt()],Ce.prototype,"_timerDialogOpen",void 0),t([pt()],Ce.prototype,"_schedules",void 0),Ce=t([lt(fe)],Ce);const Se="hac-plug-group-card",Ee="hac-plug-group-card-editor",Ae=[vt,bt,r`
  /* Header */
  .header {
    display: flex;
    align-items: center;
...
`];function Oe(t,e){return e.map(e=>{const i=wt(t,e),s=t.states[e];return{entityId:e,name:s?.attributes.friendly_name||e,power:xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:xt(t,i,"sensor",{keywords:["yearly"]}),childLock:xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:xt(t,i,"select",{keywords:["power_on"]})}})}function ze(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}function Me(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}function Pe(t,e,i){let s=0,o=!1;for(const n of e){const e=n[i];if(!e)continue;const r=ze(t,e);void 0!==r&&(s+=r,o=!0)}return o?s:void 0}function De(t,e){return e.some(e=>"on"===t.states[e]?.state)}function Te(t,e,i,s){const o=[{key:"power",labelKey:"stats.power",configKey:"show_power"},{key:"dailyConsumption",labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{key:"monthlyConsumption",labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{key:"yearlyConsumption",labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(i=>!1!==s[i.configKey]&&void 0!==Pe(t,e,i.key));return 0===o.length?q:K`
    <div class="stats-grid">
      ${o.map(s=>{const o=Pe(t,e,s.key),n=function(t,e,i){for(const s of e){const e=s[i];if(e){const i=Me(t,e);if(i)return i}}return""}(t,e,s.key),r=void 0!==o?void 0!==s.decimals?o.toFixed(s.decimals):Math.round(o).toString():"—";return K`
          <div class="stat-item">
            <span class="stat-value">
              ${r}
  ...
  `}const Le=[{name:"entities",required:!0,selector:{entity:{domain:"switch",multiple:!0}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_power",selector:{boolean:{}}},{name:"show_daily_consumption",selector:{boolean:{}}},{name:"show_monthly_consumption",selector:{boolean:{}}},{name:"show_yearly_consumption",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_individual",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let Ie=class extends at{constructor(){super(...arguments),this._computeLabel=t=>"entities"===t.name?mt("editor.entities",this.hass?.language||"en"):"show_individual"===t.name?mt("editor.show_individual",this.hass?.language||"en"):Xt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}_powerOnBehaviorChanged(t,e){const i=t.target;i.value&&this.hass.callService("select","select_option",{entity_id:e,option:i.value})}_childLockChanged(t){this.hass.callService("switch","toggle",{entity_id:t})}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_power:!0,show_daily_consumption:!0,show_monthly_consumption:!0,show_yearly_consumption:!0,show_settings:!0,show_individual:!0,compact_view:!1,icon_animation:!0,...this._config},i=this._config.entities||[],s=(i.length>0?Oe(this.hass,i):[]).filter(t=>t.powerOnBehavior||t.childLock);return K`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${Le}
  ...
  `],t([ut({attribute:!1})],Ie.prototype,"hass",void 0),t([pt()],Ie.prototype,"_config",void 0),Ie=t([lt(Ee)],Ie),St({type:Se,name:"Plug Group",description:"Group card for multiple smart plugs"});let Ue=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(Ee)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("switch."));return{entities:e.slice(0,2)}}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("At least one entity is required");this._config=t}getCardSize(){return this._config?.compact_view?2:4}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;const i=this._getResolved();for(const t of i)for(const i of[t.power,t.dailyConsumption,t.monthlyConsumption,t.yearlyConsumption,t.childLock])if(i&&e.states[i]!==this.hass.states[i])return!0;return!1}updated(t){if(t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer){this._schedulerConnected=!0;const t=this._config.entities[0];this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(t)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(t)}}_getResolved(){const t=JSON.stringify(this._config.entities);return this._resolved&&this._lastEntitiesKey===t||(this._lastEntitiesKey=t,this._resolved=Oe(this.hass,this._config.entities)),this._resolved}get _lang(){return this.hass?.language||"en"}_handleMasterToggle(){const t=this._config.entities,e=De(this.hass,t)?"turn_off":"turn_on";this.hass.callService("switch",e,{entity_id:t})}render(){if(!this.hass||!this._config)return q;if(0===this._config.entities.filter(t=>this.hass.states[t]).length)return K`
        <ha-card>
          <div class="not-found">No entities found</div>
        </ha-card>
      `;const t=this._getResolved(),e=De(this.hass,this._config.entities),i=this._config.name||mt("plug-group.card.name",this._lang),s=this._lang,o=this._config.compact_view;return K`
      <ha-card>
        <div class="container">
          ${this._renderHeader(e,i,s,t)}
          ${o?q:Te(this.hass,t,s,this._config)}
          ${o||!1===this._config.show_individual?q:function(t,e,i){return 0===e.length?q:K`
    <div class="plug-list">
      ${e.map(e=>{const s=t.states[e.entityId];if(!s)return q;const o="on"===s.state,n=o?ze(t,e.power):void 0,r=void 0!==n?`${Math.round(n)} W`:"",a=o?r||mt("state.on",i):mt("state.off",i);return K`
  ...
  `}(this.hass,t,s)}
        ...
        ${this._config.show_timer?Ft(this.hass,this._config.entities,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=(n=this.hass,this._config.entities.filter(t=>"on"===n.states[t]?.state).length);var n;const r=this._config.entities.length,a=t?`${o} / ${r} ${mt("state.on",i)}`:mt("state.off",i),c=t?Pe(this.hass,s,"power"):void 0,l=t&&void 0!==c?`${a} · ${Math.round(c)} W`:a;return K`
      <div class="header">
        <hac-shape-icon
          icon="mdi:power-plug"
          ?active=${t}
    ...
    `}};Ue.styles=[gt,Ae],t([ut({attribute:!1})],Ue.prototype,"hass",void 0),t([pt()],Ue.prototype,"_config",void 0),t([pt()],Ue.prototype,"_timerDialogOpen",void 0),t([pt()],Ue.prototype,"_schedules",void 0),Ue=t([lt(Se)],Ue);const He="hac-timer-card",Ne="hac-timer-card-editor",je=[bt,r`
  .header {
    display: flex;
    align-items: center;
    gap: 12px;
...
`],Re=[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_presets",selector:{boolean:{}}}]},{name:"default_action",selector:{select:{options:[{value:"turn_off",label:"Turn Off"},{value:"turn_on",label:"Turn On"},{value:"toggle",label:"Toggle"}]}}}];let Fe=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Xt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}render(){if(!this.hass||!this._config)return q;const t={show_name:!0,show_state:!0,show_presets:!0,default_action:"turn_off",...this._config};return K`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${Re}
    ...
    `}_renderHeader(t,e,i,s,o){const n=this._schedules.filter(t=>!t.recurring),r=n.length>0?n[0]:null;let a=s;if(r){a=`${s} · ${Dt(r.action,o)}`}return K`
      <div class="header">
        <button
        ...
        ${i.length>0?K`
              ...
              ${i.map(e=>K`
                  <div class="timer-item">
                    <ha-icon class="recurring-icon" icon="mdi:calendar-clock"></ha-icon>
                    <span class="recurring-info">
                      ${e.days_of_week?function(t,e){return t.map(t=>mt(Ke[t],e)).join(", ")}(e.days_of_week,t):""}
                      ${e.trigger_at?function(t){const e=new Date(t);return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}(e.trigger_at):""}
                    </span>
                    <span class="action-text">
                      ${Dt(e.action,t)}
