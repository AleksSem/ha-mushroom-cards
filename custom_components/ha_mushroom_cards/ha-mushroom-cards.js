...
`];function wt(t,e){if(!t.entities)return[];const i=t.entities[e];if(!i?.device_id)return[];const s=i.device_id;return Object.values(t.entities).filter(t=>t.device_id===s).map(t=>t.entity_id)}function xt(t,e,i,s){const o=i.endsWith(".")?i:i+".",n=e.filter(e=>e.startsWith(o)&&t.states[e]);if(0===n.length)return;if(!s)return n[0];const{deviceClass:r,keywords:a}=s,c=e=>!!r&&t.states[e]?.attributes.device_class===r,l=t=>!(!a||0===a.length)&&a.some(e=>t.includes(e)),h=n.find(t=>c(t)&&l(t));if(h)return h;const d=n.find(t=>c(t));if(d)return d;const u=n.find(t=>l(t));return u||void 0}function kt(t){return t.attributes.preset_mode}function Ct(t,e){const i=function(t,e){if(!e)return;const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:void 0}(t,e);if(void 0===i)return;const s=parseFloat(i);return isNaN(s)?void 0:s}function St(t){const e=window;e.customCards=e.customCards||[],e.customCards.push(t)}function Et(t,e,i,s,o){t.callService(e,i,{entity_id:s,...o})}function At(t,e){Et(t,e.split(".")[0],"toggle",e)}function Ot(t,e,i){Et(t,e.split(".")[0],"turn_on",e,i)}function zt(t,e,i,s,o){if(0===i.length)return q;const n=i=>{o||Ot(t,e),function(t,e,i){Et(t,"fan","set_preset_mode",e,{preset_mode:i})}(t,e,i)};return B`
  ...
  `}function Mt(t,e){if(!e)return q;const i=t.states[e];if(!i)return q;const s=Ct(t,e)??0,o=i.attributes.min??0,n=i.attributes.max??14,r=i.attributes.step??1;return B`
  ...
  `,t([ut()],It.prototype,"lang",void 0),t([ut({type:Array})],It.prototype,"presets",void 0),t([ut()],It.prototype,"action",void 0),t([ut({type:Boolean})],It.prototype,"disabled",void 0),t([pt()],It.prototype,"_mode",void 0),t([pt()],It.prototype,"_hours",void 0),t([pt()],It.prototype,"_minutes",void 0),t([pt()],It.prototype,"_timeValue",void 0),t([pt()],It.prototype,"_selectedAction",void 0),It=t([lt("hac-timer-picker")],It);let Nt=class extends at{constructor(){super(...arguments),this.compact=!1,this._remaining=""}connectedCallback(){super.connectedCallback(),this._updateCountdown(),this._interval=setInterval(()=>this._updateCountdown(),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._interval&&(clearInterval(this._interval),this._interval=void 0)}updated(t){t.has("schedule")&&this._updateCountdown()}_updateCountdown(){if(!this.schedule)return;const t=Date.now(),e=new Date(this.schedule.trigger_at).getTime(),i=Math.max(0,e-t);if(0===i)return this._remaining="00:00",void(this._interval&&(clearInterval(this._interval),this._interval=void 0));const s=Math.floor(i/1e3),o=Math.floor(s/3600),n=Math.floor(s%3600/60),r=s%60,a=t=>String(t).padStart(2,"0");this._remaining=o>0?`${a(o)}:${a(n)}:${a(r)}`:`${a(n)}:${a(r)}`}_cancel(){this.dispatchEvent(new CustomEvent("timer-cancel",{detail:{scheduleId:this.schedule.id},bubbles:!0,composed:!0}))}render(){return this.compact?B`
  ...
  `,t([ut({attribute:!1})],Nt.prototype,"schedule",void 0),t([ut({type:Boolean})],Nt.prototype,"compact",void 0),t([pt()],Nt.prototype,"_remaining",void 0),Nt=t([lt("hac-timer-badge")],Nt);let Dt=class extends at{constructor(){super(...arguments),this.entityId="",this.entityName="",this.open=!1,this.defaultAction="turn_off",this._schedules=[]}connectedCallback(){super.connectedCallback(),this._unsubscribe=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this.entityId)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}updated(t){t.has("hass")&&this.hass&&Pt.connect(this.hass),t.has("entityId")&&(this._schedules=Pt.getSchedulesForEntity(this.entityId))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!0,composed:!0}))}async _onTimerStart(t){const e=Tt(this.entityId,t.detail);await Pt.createSchedule(this.hass,e)}async _cancelSchedule(t){await Pt.cancelSchedule(this.hass,t)}render(){if(!this.open)return q;const t=this.hass?.language||"en";return B`
      <ha-dialog
        .open=${this.open}
        @closed=${this._close}
    ...
    `}};function Ht(t,e){const i=t.length>0,s=t[0];return B`
  ...
  `}function Rt(t,e,i,s,o,n){return B`
    <hac-timer-dialog
      .hass=${t}
      .entityId=${e}
      .entityName=${i}
  ...
  `,t([ut({attribute:!1})],Dt.prototype,"hass",void 0),t([ut()],Dt.prototype,"entityId",void 0),t([ut()],Dt.prototype,"entityName",void 0),t([ut({type:Boolean})],Dt.prototype,"open",void 0),t([ut()],Dt.prototype,"defaultAction",void 0),t([pt()],Dt.prototype,"_schedules",void 0),Dt=t([lt("hac-timer-dialog")],Dt);const jt=r`
  @keyframes spin {
...
`;let Ft=class extends at{constructor(){super(...arguments),this.icon="mdi:air-purifier",this.active=!1,this.animated=!0,this.animation="spin"}render(){const t=this.active&&this.animated?this.animation:"";return B`
  ...
  `],t([ut()],Ft.prototype,"icon",void 0),t([ut({type:Boolean})],Ft.prototype,"active",void 0),t([ut({type:Boolean})],Ft.prototype,"animated",void 0),t([ut()],Ft.prototype,"animation",void 0),Ft=t([lt("hac-shape-icon")],Ft);let Bt=class extends at{constructor(){super(...arguments),this.primary="",this.secondary=""}render(){return B`
      ${this.primary?B`<span class="primary">${this.primary}</span>`:q}
      ${this.secondary?B`<span class="secondary">${this.secondary}</span>`:q}
    `}};Bt.styles=r`
    :host {
      display: flex;
      flex-direction: column;
  ...
  `,t([ut()],Bt.prototype,"primary",void 0),t([ut()],Bt.prototype,"secondary",void 0),Bt=t([lt("hac-state-info")],Bt);let Kt=class extends at{render(){return B`
      <div class="container">
        <slot name="icon"></slot>
        <slot name="info"></slot>
      </div>
  ...
  `,Kt=t([lt("hac-state-item")],Kt);let qt=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){const t=(this.value-this.min)/(this.max-this.min)*100;return B`
  ...
  `,t([ut({type:Number})],qt.prototype,"value",void 0),t([ut({type:Number})],qt.prototype,"min",void 0),t([ut({type:Number})],qt.prototype,"max",void 0),t([ut({type:Number})],qt.prototype,"step",void 0),t([ut({type:Boolean})],qt.prototype,"disabled",void 0),qt=t([lt("hac-slider")],qt);let Wt=class extends at{constructor(){super(...arguments),this.value=0,this.color="var(--primary-color)"}render(){const t=Math.min(100,Math.max(0,this.value));return B`
      <div class="bar">
  ...
  `,t([ut({type:Number})],Wt.prototype,"value",void 0),t([ut()],Wt.prototype,"color",void 0),Wt=t([lt("hac-progress-bar")],Wt);let Vt=class extends at{constructor(){super(...arguments),this.icon="",this.active=!1,this.label=""}_handleClick(){this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}render(){return B`
      <button
  ...
  `,t([ut()],Vt.prototype,"icon",void 0),t([ut({type:Boolean})],Vt.prototype,"active",void 0),t([ut()],Vt.prototype,"label",void 0),Vt=t([lt("hac-toggle-button")],Vt);const Gt=r`
  :host {
    display: block;
    --ha-space-6: 4px;
  }
...
`;function Jt(t,e){const i=t?.language||"en";return mt(`editor.${e.name}`,i)||e.name}function Xt(t,e){t.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const Yt=[{name:"entity",required:!0,selector:{entity:{domain:"fan"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_toolbar",selector:{boolean:{}}},{name:"show_stats",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_filter_info",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],Zt=[{name:"pm25_entity",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"motor_speed_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_life_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_used_time_entity",selector:{entity:{domain:"sensor"}}},{name:"favorite_level_entity",selector:{entity:{domain:"number"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"led_entity",selector:{entity:{}}},{name:"buzzer_entity",selector:{entity:{domain:"switch"}}}];let Qt=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Xt(this,t.detail.value)}_overrideValueChanged(t){Xt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_toolbar:!0,show_stats:!0,show_settings:!0,show_filter_info:!0,compact_view:!1,icon_animation:!0,...this._config};return B`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${Yt}
      ...
      ${s.map(e=>{const s=Ct(t,e.entityId),o=function(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}(t,e.entityId),n="pm25"===e.key&&void 0!==s,r=n?`background: ${a=s,a<=12?"var(--green-color, #4caf50)":a<=35?"var(--light-green-color, #8bc34a)":a<=55?"var(--yellow-color, #ffeb3b)":a<=150?"var(--orange-color, #ff9800)":a<=250?"var(--deep-orange-color, #ff5722)":"var(--red-color, #f44336)"}; color: #fff;`:"";var a;return B`
          <div class="stat-item" style=${r}>
            <span class="stat-value">
              ...
              ${o?B`<span class="stat-unit" style=${n?"color: inherit;":""}>${o}</span>`:""}
            </span>
  ...
  `}(this.hass,e,a)}
          ...
          ${c||!1===this._config.show_filter_info?q:function(t,e,i,s){const o=Ct(t,e),n=Ct(t,i);if(void 0===o&&void 0===n)return q;const r=o??0,a=(c=r)>50?"var(--green-color, #4caf50)":c>20?"var(--orange-color, #ff9800)":"var(--red-color, #f44336)";var c;return B`
    <div class="filter-section">
      <div class="filter-header">
        <span>${mt("filter.life",s)}</span>
        <span>
          ${void 0!==o?B`<span class="value">${Math.round(o)}%</span>`:""}
          ${void 0!==n?B` · ${Math.round(n)} ${mt("filter.hours",s)}`:""}
        </span>
      </div>
      ${void 0!==o?B`<hac-progress-bar .value=${r} .color=${a}></hac-progress-bar>`:q}
    </div>
  `}(this.hass,e.filterLife,e.filterUsedTime,a)}
          ${c||!1===this._config.show_settings?q:function(t,e,i,s,o){const n=[{entityId:e,icon:"mdi:lock",labelKey:"settings.child_lock"},{entityId:i,icon:"mdi:lightbulb-outline",labelKey:"settings.led"},{entityId:s,icon:"mdi:volume-high",labelKey:"settings.buzzer"}].filter(e=>e.entityId&&t.states[e.entityId]);return 0===n.length?q:B`
  ...
  `}(this.hass,e.childLock,e.led,e.buzzer,a)}
        ...
        ${this._config.show_timer?Rt(this.hass,this._config.entity,s,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),n=e?kt(t):void 0,r=n?`${o} · ${n}`:o;return B`
      <div class="header">
...
`];function oe(t){return t.attributes.supported_color_modes||[]}function ne(t){return"on"===t.state}function re(t){const e=t.attributes.brightness;return null==e?ne(t)?100:0:Math.max(1,Math.round(e/255*100))}function ae(t){const e=t/100;let i,s,o;return i=e<=66?255:329.698727446*Math.pow(e-60,-.1332047592),s=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*Math.pow(e-60,-.0755148492),o=e>=66?255:e<=19?0:138.5177312231*Math.log(e-10)-305.0447927307,[Math.round(Math.min(255,Math.max(0,i))),Math.round(Math.min(255,Math.max(0,s))),Math.round(Math.min(255,Math.max(0,o)))]}function ce(t,e,i,s,o,n){const r=n&&s?function(t){if(!ne(t))return;const e=function(t){return t.attributes.rgb_color}(t);if(e)return`rgb(${e[0]}, ${e[1]}, ${e[2]})`;const i=t.attributes.color_temp_kelvin;if(i){const[t,e,s]=ae(i);return`rgb(${t}, ${e}, ${s})`}}(i):void 0;return B`
    <hac-shape-icon
      icon="mdi:lightbulb"
      ?active=${s}
      .animated=${o}
      ...
      @click=${()=>At(t,e)}
    ></hac-shape-icon>
  `}function le(t,e,i,s,o){const n=function(t,e){const i=[];for(let s=0;s<=5;s++){const o=t+s/5*(e-t),[n,r,a]=ae(o);i.push(`rgb(${n}, ${r}, ${a})`)}return`linear-gradient(to right, ${i.join(", ")})`}(s,o);return B`
  ...
  `}let de=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.gradient=""}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){return B`
      <div class="slider-container">
        <input
          type="range"
          .value=${String(this.value)}
  ...
  `,t([ut({type:Number})],de.prototype,"value",void 0),t([ut({type:Number})],de.prototype,"min",void 0),t([ut({type:Number})],de.prototype,"max",void 0),t([ut({type:Number})],de.prototype,"step",void 0),t([ut({type:Boolean})],de.prototype,"disabled",void 0),t([ut()],de.prototype,"gradient",void 0),de=t([lt("hac-gradient-slider")],de);const ue=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_brightness_control",selector:{boolean:{}}},{name:"show_color_temp_control",selector:{boolean:{}}},{name:"show_color_control",selector:{boolean:{}}},{name:"use_light_color",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"hide_controls_when_off",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let pe=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Xt(this,t.detail.value)}render(){if(!this.hass||!this._config)return q;const t={show_name:!0,show_state:!0,show_brightness_control:!0,show_color_temp_control:!0,show_color_control:!0,use_light_color:!0,icon_animation:!0,compact_view:!1,hide_controls_when_off:!0,...this._config};return B`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${ue}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}};pe.styles=Gt,t([ut({attribute:!1})],pe.prototype,"hass",void 0),t([pt()],pe.prototype,"_config",void 0),pe=t([lt(ie)],pe),St({type:ee,name:"Light Card",description:"Custom card for light entities with brightness and color controls"});let _e=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}static getConfigElement(){return document.createElement(ie)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("light."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?1:3}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return q;const t=this.hass.states[this._config.entity];if(!t)return B`
        <ha-card>
          <div class="not-found">Entity not found: ${this._config.entity}</div>
        </ha-card>
      `;const e=ne(t),i=this._config.name||t.attributes.friendly_name||"Light",s=this._lang,o=this._config.compact_view;return B`
      <ha-card>
        <div class="container">
          ${this._renderHeader(t,e,i,s)}
          ${o||!e&&!1!==this._config.hide_controls_when_off?q:this._renderControls(t)}
        </div>
        ${this._config.show_timer?Rt(this.hass,this._config.entity,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),n=e?re(t):0,r=e&&n?`${o} · ${n}%`:o;return B`
      <div class="header">
        ${ce(this.hass,this._config.entity,t,e,!1!==this._config.icon_animation,!1!==this._config.use_light_color)}
        ${!1!==this._config.show_name||!1!==this._config.show_state?B`
            <hac-state-info
              .primary=${!1!==this._config.show_name?i:""}
              .secondary=${!1!==this._config.show_state?r:""}
    ...
    `}_renderControls(t){const e=this._config.entity;return B`
      ${!1!==this._config.show_brightness_control&&function(t){const e=oe(t);return e.length>0&&!e.every(t=>"onoff"===t)}(t)?function(t,e,i){return B`
    <div class="control-row">
...
`];function ye(t,e){const i=wt(t,e.entity);return{power:e.power_entity||xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:e.daily_consumption_entity||xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:e.monthly_consumption_entity||xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:e.yearly_consumption_entity||xt(t,i,"sensor",{keywords:["yearly"]}),childLock:e.child_lock_entity||xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:e.power_on_behavior_entity||xt(t,i,"select",{keywords:["power_on"]})}}function ve(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}const be=[{name:"entity",required:!0,selector:{entity:{domain:"switch"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_power",selector:{boolean:{}}},{name:"show_daily_consumption",selector:{boolean:{}}},{name:"show_monthly_consumption",selector:{boolean:{}}},{name:"show_yearly_consumption",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],$e=[{name:"power_entity",selector:{entity:{domain:"sensor"}}},{name:"daily_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"monthly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"yearly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"power_on_behavior_entity",selector:{entity:{domain:"select"}}}];let we=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Xt(this,t.detail.value)}_overrideValueChanged(t){Xt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}_powerOnBehaviorChanged(t){const e=t.target,i=this._resolvedEntities.powerOnBehavior;i&&e.value&&this.hass.callService("select","select_option",{entity_id:i,option:e.value})}_childLockChanged(){const t=this._resolvedEntities.childLock;t&&this.hass.callService("switch","toggle",{entity_id:t})}get _resolvedEntities(){return ye(this.hass,this._config)}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_power:!0,show_daily_consumption:!0,show_monthly_consumption:!0,show_yearly_consumption:!0,show_settings:!0,compact_view:!1,icon_animation:!0,...this._config},i=this._resolvedEntities,s=i.childLock,o=!!s&&"on"===this.hass.states[s]?.state,n=i.powerOnBehavior,r=n?this.hass.states[n]:void 0,a=r?.attributes.options||[],c=r?.state;return B`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${be}
      ...
      ${a.length>0?B`
        ...
        >
          ${a.map(t=>B`<mwc-list-item .value=${t}>${t}</mwc-list-item>`)}
        </ha-select>
      `:q}
  ...
  `],t([ut({attribute:!1})],we.prototype,"hass",void 0),t([pt()],we.prototype,"_config",void 0),t([pt()],we.prototype,"_expandedOverrides",void 0),we=t([lt(ge)],we),St({type:me,name:"Plug Card",description:"Custom card for smart plug/socket entities"});let xe=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(ge)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("switch."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?2:4}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;if(e.states[i]!==this.hass.states[i])return!0;const s=this._getResolved();for(const t of Object.values(s))if(t&&e.states[t]!==this.hass.states[t])return!0;return!1}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}_getResolved(){return this._resolved&&this._lastEntity===this._config.entity||(this._lastEntity=this._config.entity,this._resolved=ye(this.hass,this._config)),this._resolved}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return q;const t=this.hass.states[this._config.entity];if(!t)return B`
        <ha-card>
          <div class="not-found">Entity not found: ${this._config.entity}</div>
        </ha-card>
      `;const e=this._getResolved(),i=function(t){return"on"===t.state}(t),s=this._config.name||t.attributes.friendly_name||"Plug",o=this._lang,n=this._config.compact_view;return B`
      <ha-card>
        <div class="container">
          ${this._renderHeader(t,i,s,o,e)}
          ${n?q:function(t,e,i,s){const o=[{entityId:e.power,labelKey:"stats.power",configKey:"show_power"},{entityId:e.dailyConsumption,labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{entityId:e.monthlyConsumption,labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{entityId:e.yearlyConsumption,labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(e=>!1!==s[e.configKey]&&(!!e.entityId&&void 0!==ve(t,e.entityId)));return 0===o.length?q:B`
    <div class="stats-grid">
      ${o.map(e=>{const s=ve(t,e.entityId),o=function(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}(t,e.entityId),n=void 0!==s?void 0!==e.decimals?s.toFixed(e.decimals):Math.round(s).toString():"—";return B`
          <div class="stat-item">
            <span class="stat-value">
              ${n}
              ${o?B`<span class="stat-unit">${o}</span>`:""}
            </span>
  ...
  `}(this.hass,e,o,this._config)}
          ${n||!1===this._config.show_settings?q:function(t,e,i){if(!e||!t.states[e])return q;const s="on"===t.states[e]?.state;return B`
    <div class="settings-row">
      <hac-toggle-button
        .icon=${"mdi:lock"}
        ?active=${s}
  ...
  `}(this.hass,e.childLock,o)}
    ...
    `}_renderHeader(t,e,i,s,o){const n=mt(e?"state.on":"state.off",s),r=e?ve(this.hass,o.power):void 0,a=e&&void 0!==r?`${n} · ${Math.round(r)} W`:n;return B`
      <div class="header">
        ${function(t,e,i,s){return B`
    <hac-shape-icon
      icon="mdi:power-plug"
...
`];function Ee(t,e){return e.map(e=>{const i=wt(t,e),s=t.states[e];return{entityId:e,name:s?.attributes.friendly_name||e,power:xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:xt(t,i,"sensor",{keywords:["yearly"]}),childLock:xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:xt(t,i,"select",{keywords:["power_on"]})}})}function Ae(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}function Oe(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}function ze(t,e,i){let s=0,o=!1;for(const n of e){const e=n[i];if(!e)continue;const r=Ae(t,e);void 0!==r&&(s+=r,o=!0)}return o?s:void 0}function Me(t,e){return e.some(e=>"on"===t.states[e]?.state)}function Pe(t,e,i,s){const o=[{key:"power",labelKey:"stats.power",configKey:"show_power"},{key:"dailyConsumption",labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{key:"monthlyConsumption",labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{key:"yearlyConsumption",labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(i=>!1!==s[i.configKey]&&void 0!==ze(t,e,i.key));return 0===o.length?q:B`
    <div class="stats-grid">
      ${o.map(s=>{const o=ze(t,e,s.key),n=function(t,e,i){for(const s of e){const e=s[i];if(e){const i=Oe(t,e);if(i)return i}}return""}(t,e,s.key),r=void 0!==o?void 0!==s.decimals?o.toFixed(s.decimals):Math.round(o).toString():"—";return B`
          <div class="stat-item">
            <span class="stat-value">
              ${r}
              ${n?B`<span class="stat-unit">${n}</span>`:""}
            </span>
            <span class="stat-label">${mt(s.labelKey,i)}</span>
          </div>
        `})}
    </div>
  `}const Le=[{name:"entities",required:!0,selector:{entity:{domain:"switch",multiple:!0}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_power",selector:{boolean:{}}},{name:"show_daily_consumption",selector:{boolean:{}}},{name:"show_monthly_consumption",selector:{boolean:{}}},{name:"show_yearly_consumption",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_individual",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let Te=class extends at{constructor(){super(...arguments),this._computeLabel=t=>"entities"===t.name?mt("editor.entities",this.hass?.language||"en"):"show_individual"===t.name?mt("editor.show_individual",this.hass?.language||"en"):Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Xt(this,t.detail.value)}_powerOnBehaviorChanged(t,e){const i=t.target;i.value&&this.hass.callService("select","select_option",{entity_id:e,option:i.value})}_childLockChanged(t){this.hass.callService("switch","toggle",{entity_id:t})}render(){if(!this.hass||!this._config)return q;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_power:!0,show_daily_consumption:!0,show_monthly_consumption:!0,show_yearly_consumption:!0,show_settings:!0,show_individual:!0,compact_view:!1,icon_animation:!0,...this._config},i=this._config.entities||[],s=(i.length>0?Ee(this.hass,i):[]).filter(t=>t.powerOnBehavior||t.childLock);return B`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${Le}
      ...
      ${s.length>0?B`
        <div class="device-controls">
          ...
          ${s.map(e=>{const i=e.powerOnBehavior,s=i?this.hass.states[i]:void 0,o=s?.attributes.options||[],n=s?.state,r=e.childLock,a=!!r&&"on"===this.hass.states[r]?.state;return B`
              <div class="device-row">
                ...
                <div class="device-actions">
                  ${o.length>0?B`
                    ...
                    >
                      ${o.map(t=>B`<mwc-list-item .value=${t}>${t}</mwc-list-item>`)}
                    </ha-select>
                  `:q}
                  ${r?B`
                    <ha-formfield .label=${mt("settings.child_lock",t)}>
  ...
  `],t([ut({attribute:!1})],Te.prototype,"hass",void 0),t([pt()],Te.prototype,"_config",void 0),Te=t([lt(Ce)],Te),St({type:ke,name:"Plug Group",description:"Group card for multiple smart plugs"});let Ue=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(Ce)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("switch."));return{entities:e.slice(0,2)}}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("At least one entity is required");this._config=t}getCardSize(){return this._config?.compact_view?2:4}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;const i=this._getResolved();for(const t of i)for(const i of[t.power,t.dailyConsumption,t.monthlyConsumption,t.yearlyConsumption,t.childLock])if(i&&e.states[i]!==this.hass.states[i])return!0;return!1}updated(t){if(t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer){this._schedulerConnected=!0;const t=this._config.entities[0];this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(t)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(t)}}_getResolved(){const t=JSON.stringify(this._config.entities);return this._resolved&&this._lastEntitiesKey===t||(this._lastEntitiesKey=t,this._resolved=Ee(this.hass,this._config.entities)),this._resolved}get _lang(){return this.hass?.language||"en"}_handleMasterToggle(){const t=this._config.entities,e=Me(this.hass,t)?"turn_off":"turn_on";this.hass.callService("switch",e,{entity_id:t})}render(){if(!this.hass||!this._config)return q;if(0===this._config.entities.filter(t=>this.hass.states[t]).length)return B`
        <ha-card>
          <div class="not-found">No entities found</div>
        </ha-card>
      `;const t=this._getResolved(),e=Me(this.hass,this._config.entities),i=this._config.name||mt("plug-group.card.name",this._lang),s=this._lang,o=this._config.compact_view;return B`
      <ha-card>
        <div class="container">
          ${this._renderHeader(e,i,s,t)}
          ${o?q:Pe(this.hass,t,s,this._config)}
          ${o||!1===this._config.show_individual?q:function(t,e,i){return 0===e.length?q:B`
    <div class="plug-list">
      ${e.map(e=>{const s=t.states[e.entityId];if(!s)return q;const o="on"===s.state,n=o?Ae(t,e.power):void 0,r=void 0!==n?`${Math.round(n)} W`:"",a=o?r||mt("state.on",i):mt("state.off",i);return B`
  ...
  `}(this.hass,t,s)}
          ${o||!1===this._config.show_settings?q:function(t,e,i){const s=e.map(t=>t.childLock).filter(e=>!!e&&!!t.states[e]);if(0===s.length)return q;const o=s.some(e=>"on"!==t.states[e]?.state);return B`
    <div class="settings-row">
      <hac-toggle-button
        .icon=${"mdi:lock"}
        ?active=${!o}
  ...
  `}(this.hass,t,s)}
        ...
        ${this._config.show_timer?Rt(this.hass,this._config.entities[0],i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=(n=this.hass,this._config.entities.filter(t=>"on"===n.states[t]?.state).length);var n;const r=this._config.entities.length,a=t?`${o} / ${r} ${mt("state.on",i)}`:mt("state.off",i),c=t?ze(this.hass,s,"power"):void 0,l=t&&void 0!==c?`${a} · ${Math.round(c)} W`:a;return B`
      <div class="header">
        <hac-shape-icon
          icon="mdi:power-plug"
          ?active=${t}
    ...
    `}};Ue.styles=[gt,Se],t([ut({attribute:!1})],Ue.prototype,"hass",void 0),t([pt()],Ue.prototype,"_config",void 0),t([pt()],Ue.prototype,"_timerDialogOpen",void 0),t([pt()],Ue.prototype,"_schedules",void 0),Ue=t([lt(ke)],Ue);const Ie="hac-timer-card",Ne="hac-timer-card-editor",De=[bt,r`
  .header {
    display: flex;
    align-items: center;
    gap: 12px;
...
`],He=[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_presets",selector:{boolean:{}}}]},{name:"default_action",selector:{select:{options:[{value:"turn_off",label:"Turn Off"},{value:"turn_on",label:"Turn On"},{value:"toggle",label:"Toggle"}]}}}];let Re=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Xt(this,t.detail.value)}render(){if(!this.hass||!this._config)return q;const t={show_name:!0,show_state:!0,show_presets:!0,default_action:"turn_off",...this._config};return B`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${He}
    ...
    `}_renderHeader(t,e,i,s,o){const n=this._schedules.length>0?this._schedules[0]:null;let r=s;if(n){r=`${s} · ${Lt(n.action,o)}`}return B`
      <div class="header">
        <button
    ...
    `}_renderActiveTimers(t){return B`
      <div class="active-timers">
        <div class="active-timers-title">
          ${mt("timer.active",t)}
        </div>
        ${this._schedules.length>0?this._schedules.map(e=>B`
