...
`];function wt(t,e){if(!t.entities)return[];const i=t.entities[e];if(!i?.device_id)return[];const s=i.device_id;return Object.values(t.entities).filter(t=>t.device_id===s).map(t=>t.entity_id)}function xt(t,e,i,s){const o=i.endsWith(".")?i:i+".",n=e.filter(e=>e.startsWith(o)&&t.states[e]);if(0===n.length)return;if(!s)return n[0];const{deviceClass:r,keywords:a}=s,c=e=>!!r&&t.states[e]?.attributes.device_class===r,l=t=>!(!a||0===a.length)&&a.some(e=>t.includes(e)),h=n.find(t=>c(t)&&l(t));if(h)return h;const d=n.find(t=>c(t));if(d)return d;const u=n.find(t=>l(t));return u||void 0}function kt(t){return t.attributes.preset_mode}function Ct(t,e){const i=function(t,e){if(!e)return;const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:void 0}(t,e);if(void 0===i)return;const s=parseFloat(i);return isNaN(s)?void 0:s}function St(t){const e=window;e.customCards=e.customCards||[],e.customCards.push(t)}function At(t,e,i,s,o){t.callService(e,i,{entity_id:s,...o})}function Et(t,e){At(t,e.split(".")[0],"toggle",e)}function Ot(t,e,i){At(t,e.split(".")[0],"turn_on",e,i)}function zt(t,e,i,s,o){if(0===i.length)return K;const n=i=>{o||Ot(t,e),function(t,e,i){At(t,"fan","set_preset_mode",e,{preset_mode:i})}(t,e,i)};return q`
    <div class="toolbar">
  ...
  `}function Mt(t,e){if(!e)return K;const i=t.states[e];if(!i)return K;const s=Ct(t,e)??0,o=i.attributes.min??0,n=i.attributes.max??14,r=i.attributes.step??1;return q`
  ...
  `,t([ut({attribute:!1})],Nt.prototype,"schedule",void 0),t([ut({type:Boolean})],Nt.prototype,"compact",void 0),t([pt()],Nt.prototype,"_remaining",void 0),Nt=t([lt("hac-timer-badge")],Nt);let Ht=class extends at{constructor(){super(...arguments),this.entityId="",this.entityName="",this.open=!1,this.defaultAction="turn_off",this._schedules=[]}connectedCallback(){super.connectedCallback(),this._unsubscribe=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this.entityId)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}updated(t){t.has("hass")&&this.hass&&Pt.connect(this.hass),t.has("entityId")&&(this._schedules=Pt.getSchedulesForEntity(this.entityId))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!0,composed:!0}))}async _onTimerStart(t){const e=Ut(this.entityId,t.detail);await Pt.createSchedule(this.hass,e)}async _cancelSchedule(t){await Pt.cancelSchedule(this.hass,t)}render(){if(!this.open)return K;const t=this.hass?.language||"en";return q`
      <ha-dialog
        .open=${this.open}
        @closed=${this._close}
    ...
    `}};function Dt(t,e){const i=t.length>0,s=t[0];return q`
  ...
  `}function jt(t,e,i,s,o,n){return q`
    <hac-timer-dialog
      .hass=${t}
      .entityId=${e}
      .entityName=${i}
  ...
  `,t([ut({attribute:!1})],Ht.prototype,"hass",void 0),t([ut()],Ht.prototype,"entityId",void 0),t([ut()],Ht.prototype,"entityName",void 0),t([ut({type:Boolean})],Ht.prototype,"open",void 0),t([ut()],Ht.prototype,"defaultAction",void 0),t([pt()],Ht.prototype,"_schedules",void 0),Ht=t([lt("hac-timer-dialog")],Ht);const Rt=r`
  @keyframes spin {
...
`;let Ft=class extends at{constructor(){super(...arguments),this.icon="mdi:air-purifier",this.active=!1,this.animated=!0,this.animation="spin"}render(){const t=this.active&&this.animated?this.animation:"";return q`
  ...
  `],t([ut()],Ft.prototype,"icon",void 0),t([ut({type:Boolean})],Ft.prototype,"active",void 0),t([ut({type:Boolean})],Ft.prototype,"animated",void 0),t([ut()],Ft.prototype,"animation",void 0),Ft=t([lt("hac-shape-icon")],Ft);let qt=class extends at{constructor(){super(...arguments),this.primary="",this.secondary=""}render(){return q`
      ${this.primary?q`<span class="primary">${this.primary}</span>`:K}
      ${this.secondary?q`<span class="secondary">${this.secondary}</span>`:K}
    `}};qt.styles=r`
    :host {
      display: flex;
      flex-direction: column;
  ...
  `,t([ut()],qt.prototype,"primary",void 0),t([ut()],qt.prototype,"secondary",void 0),qt=t([lt("hac-state-info")],qt);let Bt=class extends at{render(){return q`
      <div class="container">
        <slot name="icon"></slot>
        <slot name="info"></slot>
      </div>
  ...
  `,Bt=t([lt("hac-state-item")],Bt);let Kt=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){const t=(this.value-this.min)/(this.max-this.min)*100;return q`
  ...
  `,t([ut({type:Number})],Kt.prototype,"value",void 0),t([ut({type:Number})],Kt.prototype,"min",void 0),t([ut({type:Number})],Kt.prototype,"max",void 0),t([ut({type:Number})],Kt.prototype,"step",void 0),t([ut({type:Boolean})],Kt.prototype,"disabled",void 0),Kt=t([lt("hac-slider")],Kt);let Vt=class extends at{constructor(){super(...arguments),this.value=0,this.color="var(--primary-color)"}render(){const t=Math.min(100,Math.max(0,this.value));return q`
      <div class="bar">
  ...
  `,t([ut({type:Number})],Vt.prototype,"value",void 0),t([ut()],Vt.prototype,"color",void 0),Vt=t([lt("hac-progress-bar")],Vt);let Wt=class extends at{constructor(){super(...arguments),this.icon="",this.active=!1,this.label=""}_handleClick(){this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}render(){return q`
      <button
  ...
  `,t([ut()],Wt.prototype,"icon",void 0),t([ut({type:Boolean})],Wt.prototype,"active",void 0),t([ut()],Wt.prototype,"label",void 0),Wt=t([lt("hac-toggle-button")],Wt);const Xt=r`
  :host {
    display: block;
    --ha-space-6: 4px;
  }
...
`;function Yt(t,e){const i=t?.language||"en";return mt(`editor.${e.name}`,i)||e.name}function Jt(t,e){t.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const Zt=[{name:"entity",required:!0,selector:{entity:{domain:"fan"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_toolbar",selector:{boolean:{}}},{name:"show_stats",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_filter_info",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],Gt=[{name:"pm25_entity",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"motor_speed_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_life_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_used_time_entity",selector:{entity:{domain:"sensor"}}},{name:"favorite_level_entity",selector:{entity:{domain:"number"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"led_entity",selector:{entity:{}}},{name:"buzzer_entity",selector:{entity:{domain:"switch"}}}];let Qt=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Yt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Jt(this,t.detail.value)}_overrideValueChanged(t){Jt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}render(){if(!this.hass||!this._config)return K;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_toolbar:!0,show_stats:!0,show_settings:!0,show_filter_info:!0,compact_view:!1,icon_animation:!0,...this._config};return q`
      <ha-form
        .hass=${this.hass}
        .data=${e}
        .schema=${Zt}
      ...
      ${s.map(e=>{const s=Ct(t,e.entityId),o=function(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}(t,e.entityId),n="pm25"===e.key&&void 0!==s,r=n?`background: ${a=s,a<=12?"var(--green-color, #4caf50)":a<=35?"var(--light-green-color, #8bc34a)":a<=55?"var(--yellow-color, #ffeb3b)":a<=150?"var(--orange-color, #ff9800)":a<=250?"var(--deep-orange-color, #ff5722)":"var(--red-color, #f44336)"}; color: #fff;`:"";var a;return q`
          <div class="stat-item" style=${r}>
            <span class="stat-value">
              ...
              ${o?q`<span class="stat-unit" style=${n?"color: inherit;":""}>${o}</span>`:""}
            </span>
  ...
  `}(this.hass,e,a)}
          ${!1!==this._config.show_toolbar?zt(this.hass,this._config.entity,o,n,i):K}
          ${i&&r?Mt(this.hass,e.favoriteLevel):K}
          ${c||!1===this._config.show_filter_info?K:function(t,e,i,s){const o=Ct(t,e),n=Ct(t,i);if(void 0===o&&void 0===n)return K;const r=o??0,a=(c=r)>50?"var(--green-color, #4caf50)":c>20?"var(--orange-color, #ff9800)":"var(--red-color, #f44336)";var c;return q`
    <div class="filter-section">
      <div class="filter-header">
        <span>${mt("filter.life",s)}</span>
        <span>
          ${void 0!==o?q`<span class="value">${Math.round(o)}%</span>`:""}
          ${void 0!==n?q` · ${Math.round(n)} ${mt("filter.hours",s)}`:""}
        </span>
      </div>
      ${void 0!==o?q`<hac-progress-bar .value=${r} .color=${a}></hac-progress-bar>`:K}
    </div>
  `}(this.hass,e.filterLife,e.filterUsedTime,a)}
          ${c||!1===this._config.show_settings?K:function(t,e,i,s,o){const n=[{entityId:e,icon:"mdi:lock",labelKey:"settings.child_lock"},{entityId:i,icon:"mdi:lightbulb-outline",labelKey:"settings.led"},{entityId:s,icon:"mdi:volume-high",labelKey:"settings.buzzer"}].filter(e=>e.entityId&&t.states[e.entityId]);return 0===n.length?K:q`
  ...
  `}(this.hass,e.childLock,e.led,e.buzzer,a)}
        ...
        ${this._config.show_timer?jt(this.hass,this._config.entity,s,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):K}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),n=e?kt(t):void 0,r=n?`${o} · ${n}`:o;return q`
      <div class="header">
  ...
  `}(this.hass,this._config.entity,e,!1!==this._config.icon_animation)}
        ${!1!==this._config.show_name||!1!==this._config.show_state?q`
            ...
            ></hac-state-info>
          `:K}
        ${this._config.show_timer?Dt(this._schedules,()=>{this._timerDialogOpen=!0}):K}
      </div>
...
`];function oe(t){return t.attributes.supported_color_modes||[]}function ne(t){return"on"===t.state}function re(t){const e=t.attributes.brightness;return null==e?ne(t)?100:0:Math.max(1,Math.round(e/255*100))}function ae(t){const e=t/100;let i,s,o;return i=e<=66?255:329.698727446*Math.pow(e-60,-.1332047592),s=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*Math.pow(e-60,-.0755148492),o=e>=66?255:e<=19?0:138.5177312231*Math.log(e-10)-305.0447927307,[Math.round(Math.min(255,Math.max(0,i))),Math.round(Math.min(255,Math.max(0,s))),Math.round(Math.min(255,Math.max(0,o)))]}function ce(t,e,i,s,o,n){const r=n&&s?function(t){if(!ne(t))return;const e=function(t){return t.attributes.rgb_color}(t);if(e)return`rgb(${e[0]}, ${e[1]}, ${e[2]})`;const i=t.attributes.color_temp_kelvin;if(i){const[t,e,s]=ae(i);return`rgb(${t}, ${e}, ${s})`}}(i):void 0;return q`
    <hac-shape-icon
      icon="mdi:lightbulb"
      ?active=${s}
      .animated=${o}
      ...
      @click=${()=>Et(t,e)}
    ></hac-shape-icon>
  `}function le(t,e,i,s,o){const n=function(t,e){const i=[];for(let s=0;s<=5;s++){const o=t+s/5*(e-t),[n,r,a]=ae(o);i.push(`rgb(${n}, ${r}, ${a})`)}return`linear-gradient(to right, ${i.join(", ")})`}(s,o);return q`
  ...
  `}let de=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1,this.gradient=""}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){return q`
      <div class="slider-container">
        <input
          type="range"
          .value=${String(this.value)}
  ...
  `,t([ut({type:Number})],de.prototype,"value",void 0),t([ut({type:Number})],de.prototype,"min",void 0),t([ut({type:Number})],de.prototype,"max",void 0),t([ut({type:Number})],de.prototype,"step",void 0),t([ut({type:Boolean})],de.prototype,"disabled",void 0),t([ut()],de.prototype,"gradient",void 0),de=t([lt("hac-gradient-slider")],de);const ue=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_brightness_control",selector:{boolean:{}}},{name:"show_color_temp_control",selector:{boolean:{}}},{name:"show_color_control",selector:{boolean:{}}},{name:"use_light_color",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"hide_controls_when_off",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let pe=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Yt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Jt(this,t.detail.value)}render(){if(!this.hass||!this._config)return K;const t={show_name:!0,show_state:!0,show_brightness_control:!0,show_color_temp_control:!0,show_color_control:!0,use_light_color:!0,icon_animation:!0,compact_view:!1,hide_controls_when_off:!0,...this._config};return q`
    ...
    `}};pe.styles=Xt,t([ut({attribute:!1})],pe.prototype,"hass",void 0),t([pt()],pe.prototype,"_config",void 0),pe=t([lt(ie)],pe),St({type:ee,name:"Light Card",description:"Custom card for light entities with brightness and color controls"});let _e=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}static getConfigElement(){return document.createElement(ie)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("light."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?1:3}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return K;const t=this.hass.states[this._config.entity];if(!t)return q`
      ...
      <ha-card>
        <div class="container">
          ...
          ${o||!e&&!1!==this._config.hide_controls_when_off?K:this._renderControls(t)}
        </div>
        ${this._config.show_timer?jt(this.hass,this._config.entity,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):K}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),n=e?re(t):0,r=e&&n?`${o} · ${n}%`:o;return q`
      <div class="header">
    ...
    `}_renderControls(t){const e=this._config.entity;return q`
      ${!1!==this._config.show_brightness_control&&function(t){const e=oe(t);return e.length>0&&!e.every(t=>"onoff"===t)}(t)?function(t,e,i){return q`
    <div class="control-row">
  ...
  `}(this.hass,e,re(t)):K}
      ${!1!==this._config.show_color_temp_control&&function(t){return oe(t).includes("color_temp")}(t)?this._renderColorTemp(t,e):K}
      ${!1!==this._config.show_color_control&&function(t){const e=["hs","xy","rgb","rgbw","rgbww"];return oe(t).some(t=>e.includes(t))}(t)?he(this.hass,e,function(t){return t.attributes.hs_color}(t)?.[0]??0):K}
...
`];function ye(t,e){const i=wt(t,e.entity);return{power:e.power_entity||xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:e.daily_consumption_entity||xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:e.monthly_consumption_entity||xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:e.yearly_consumption_entity||xt(t,i,"sensor",{keywords:["yearly"]}),childLock:e.child_lock_entity||xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:e.power_on_behavior_entity||xt(t,i,"select",{keywords:["power_on"]})}}function ve(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}const be=[{name:"entity",required:!0,selector:{entity:{domain:"switch"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_power",selector:{boolean:{}}},{name:"show_daily_consumption",selector:{boolean:{}}},{name:"show_monthly_consumption",selector:{boolean:{}}},{name:"show_yearly_consumption",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],$e=[{name:"power_entity",selector:{entity:{domain:"sensor"}}},{name:"daily_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"monthly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"yearly_consumption_entity",selector:{entity:{domain:"sensor"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"power_on_behavior_entity",selector:{entity:{domain:"select"}}}];let we=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Yt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Jt(this,t.detail.value)}_overrideValueChanged(t){Jt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}_powerOnBehaviorChanged(t){const e=t.target,i=this._resolvedEntities.powerOnBehavior;i&&e.value&&this.hass.callService("select","select_option",{entity_id:i,option:e.value})}_childLockChanged(){const t=this._resolvedEntities.childLock;t&&this.hass.callService("switch","toggle",{entity_id:t})}get _resolvedEntities(){return ye(this.hass,this._config)}render(){if(!this.hass||!this._config)return K;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_power:!0,show_daily_consumption:!0,show_monthly_consumption:!0,show_yearly_consumption:!0,show_settings:!0,compact_view:!1,icon_animation:!0,...this._config},i=this._resolvedEntities,s=i.childLock,o=!!s&&"on"===this.hass.states[s]?.state,n=i.powerOnBehavior,r=n?this.hass.states[n]:void 0,a=r?.attributes.options||[],c=r?.state;return q`
      ...
      ${a.length>0?q`
        ...
        >
          ${a.map(t=>q`<mwc-list-item .value=${t}>${t}</mwc-list-item>`)}
        </ha-select>
      `:K}
  ...
  `],t([ut({attribute:!1})],we.prototype,"hass",void 0),t([pt()],we.prototype,"_config",void 0),t([pt()],we.prototype,"_expandedOverrides",void 0),we=t([lt(ge)],we),St({type:me,name:"Plug Card",description:"Custom card for smart plug/socket entities"});let xe=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(ge)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("switch."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config=t}getCardSize(){return this._config?.compact_view?2:4}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;if(e.states[i]!==this.hass.states[i])return!0;const s=this._getResolved();for(const t of Object.values(s))if(t&&e.states[t]!==this.hass.states[t])return!0;return!1}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)}),Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}_getResolved(){return this._resolved&&this._lastEntity===this._config.entity||(this._lastEntity=this._config.entity,this._resolved=ye(this.hass,this._config)),this._resolved}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return K;const t=this.hass.states[this._config.entity];if(!t)return q`
      ...
      `;const e=this._getResolved(),i=function(t){return"on"===t.state}(t),s=this._config.name||t.attributes.friendly_name||"Plug",o=this._lang,n=this._config.compact_view;return q`
      <ha-card>
        <div class="container">
          ${this._renderHeader(t,i,s,o,e)}
          ${n?K:function(t,e,i,s){const o=[{entityId:e.power,labelKey:"stats.power",configKey:"show_power"},{entityId:e.dailyConsumption,labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{entityId:e.monthlyConsumption,labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{entityId:e.yearlyConsumption,labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(e=>!1!==s[e.configKey]&&(!!e.entityId&&void 0!==ve(t,e.entityId)));return 0===o.length?K:q`
    <div class="stats-grid">
      ${o.map(e=>{const s=ve(t,e.entityId),o=function(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}(t,e.entityId),n=void 0!==s?void 0!==e.decimals?s.toFixed(e.decimals):Math.round(s).toString():"—";return q`
          <div class="stat-item">
            <span class="stat-value">
              ${n}
  ...
  `}(this.hass,e,o,this._config)}
          ${n||!1===this._config.show_settings?K:function(t,e,i){if(!e||!t.states[e])return K;const s="on"===t.states[e]?.state;return q`
    <div class="settings-row">
      <hac-toggle-button
        .icon=${"mdi:lock"}
        ?active=${s}
  ...
  `}(this.hass,e.childLock,o)}
    ...
    `}_renderHeader(t,e,i,s,o){const n=mt(e?"state.on":"state.off",s),r=e?ve(this.hass,o.power):void 0,a=e&&void 0!==r?`${n} · ${Math.round(r)} W`:n;return q`
      <div class="header">
        ${function(t,e,i,s){return q`
    <hac-shape-icon
      icon="mdi:power-plug"
  ...
  `}(this.hass,this._config.entity,e,!1!==this._config.icon_animation)}
    ...
    `}};xe.styles=[gt,fe],t([ut({attribute:!1})],xe.prototype,"hass",void 0),t([pt()],xe.prototype,"_config",void 0),t([pt()],xe.prototype,"_timerDialogOpen",void 0),t([pt()],xe.prototype,"_schedules",void 0),xe=t([lt(me)],xe);const ke="hac-timer-card",Ce="hac-timer-card-editor",Se=[bt,r`
  .header {
    display: flex;
    align-items: center;
    gap: 12px;
...
`],Ae=[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_presets",selector:{boolean:{}}}]},{name:"default_action",selector:{select:{options:[{value:"turn_off",label:"Turn Off"},{value:"turn_on",label:"Turn On"},{value:"toggle",label:"Toggle"}]}}}];let Ee=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Yt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Jt(this,t.detail.value)}render(){if(!this.hass||!this._config)return K;const t={show_name:!0,show_state:!0,show_presets:!0,default_action:"turn_off",...this._config};return q`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${Ae}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}};Ee.styles=Xt,t([ut({attribute:!1})],Ee.prototype,"hass",void 0),t([pt()],Ee.prototype,"_config",void 0),Ee=t([lt(Ce)],Ee),St({type:ke,name:"Timer Card",description:"Schedule on/off timers for any entity"});let Oe=class extends at{constructor(){super(...arguments),this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(Ce)}static getStubConfig(t){return{entity:Object.keys(t.states)[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config={show_name:!0,show_state:!0,default_action:"turn_off",show_presets:!0,...t}}getCardSize(){return 4}connectedCallback(){super.connectedCallback(),this._unsubscribe=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._config?.entity)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}shouldUpdate(t){if(t.has("_config")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&(this._schedulerConnected=!0,Pt.connect(this.hass),this._schedules=Pt.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}_togglePower(){Et(this.hass,this._config.entity)}async _onTimerStart(t){const e=Ut(this._config.entity,t.detail);"custom"===t.detail.action&&this._config.custom_service&&(e.service=this._config.custom_service,e.service_data=this._config.custom_service_data),await Pt.createSchedule(this.hass,e)}async _cancelSchedule(t){await Pt.cancelSchedule(this.hass,t)}render(){if(!this.hass||!this._config)return K;const t=this.hass.states[this._config.entity];if(!t)return q`
        <ha-card>
          <div class="not-found">
            Entity not found: ${this._config.entity}
          </div>
        </ha-card>
      `;const e="on"===t.state,i=this._config.name||t.attributes.friendly_name||"Device",s=this._lang,o=mt(e?"state.on":"state.off",s),n=!1!==this._config.show_presets?this._config.presets||[300,600,900,1800,3600,7200]:[];return q`
      <ha-card>
        <div class="container">
    ...
    `}_renderHeader(t,e,i,s,o){const n=this._schedules.length>0?this._schedules[0]:null;let r=s;if(n){r=`${s} · ${Tt(n.action,o)}`}return q`
      <div class="header">
        <button
