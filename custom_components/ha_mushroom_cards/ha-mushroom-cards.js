...
`,gt="air-purifier-card",vt="air-purifier-card-editor",yt=n`
  .timer-control {
    display: flex;
    align-items: center;
    gap: 6px;
...
`];function xt(t,e,i){for(const s of i){const i=s.replace("{prefix}",e);if(t.states[i])return i}}function wt(t,e){const i=function(t,e){const i=(e.split(".")[1]||"").split("_").slice(0,-2).join("_");return{pm25:xt(t,i,["sensor.{prefix}_pm25_density","sensor.{prefix}_pm25","sensor.{prefix}_pm2_5"]),temperature:xt(t,i,["sensor.{prefix}_temperature","sensor.{prefix}_environment_temperature"]),humidity:xt(t,i,["sensor.{prefix}_relative_humidity","sensor.{prefix}_humidity"]),motorSpeed:xt(t,i,["sensor.{prefix}_motor_speed","sensor.{prefix}_fan_motor_speed"]),filterLife:xt(t,i,["sensor.{prefix}_filter_life_level","sensor.{prefix}_filter_life"]),filterUsedTime:xt(t,i,["sensor.{prefix}_filter_used_time"]),favoriteLevel:xt(t,i,["number.{prefix}_favorite_level","number.{prefix}_favorite_fan_level"]),childLock:xt(t,i,["switch.{prefix}_physical_control_locked","switch.{prefix}_child_lock"]),led:xt(t,i,["light.{prefix}_indicator_light","switch.{prefix}_led"]),buzzer:xt(t,i,["switch.{prefix}_alarm","switch.{prefix}_buzzer"])}}(t,e.entity);return{pm25:e.pm25_entity||i.pm25,temperature:e.temperature_entity||i.temperature,humidity:e.humidity_entity||i.humidity,motorSpeed:e.motor_speed_entity||i.motorSpeed,filterLife:e.filter_life_entity||i.filterLife,filterUsedTime:e.filter_used_time_entity||i.filterUsedTime,favoriteLevel:e.favorite_level_entity||i.favoriteLevel,childLock:e.child_lock_entity||i.childLock,led:e.led_entity||i.led,buzzer:e.buzzer_entity||i.buzzer}}function kt(t){return t.attributes.preset_mode}function At(t,e){const i=function(t,e){if(!e)return;const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:void 0}(t,e);if(void 0===i)return;const s=parseFloat(i);return isNaN(s)?void 0:s}function Ct(t){const e=window;e.customCards=e.customCards||[],e.customCards.push(t)}function St(t,e,i,s,o){t.callService(e,i,{entity_id:s,...o})}function Et(t,e){St(t,e.split(".")[0],"toggle",e)}function zt(t,e,i){St(t,e.split(".")[0],"turn_on",e,i)}function Mt(t,e,i,s,o){if(0===i.length)return V;const r=i=>{o||zt(t,e),function(t,e,i){St(t,"fan","set_preset_mode",e,{preset_mode:i})}(t,e,i)};return q`
    <div class="toolbar">
  ...
  `}function Pt(t,e){if(!e)return V;const i=t.states[e];if(!i)return V;const s=At(t,e)??0,o=i.attributes.min??0,r=i.attributes.max??14,n=i.attributes.step??1;return q`
  ...
  `,t([pt({attribute:!1})],Ht.prototype,"schedule",void 0),t([pt({type:Boolean})],Ht.prototype,"compact",void 0),t([ut()],Ht.prototype,"_remaining",void 0),Ht=t([lt("hac-timer-badge")],Ht);let It=class extends at{constructor(){super(...arguments),this.entityId="",this.entityName="",this.open=!1,this.defaultAction="turn_off",this._schedules=[]}connectedCallback(){super.connectedCallback(),this._unsubscribe=Ot.subscribe(()=>{this._schedules=Ot.getSchedulesForEntity(this.entityId)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}updated(t){t.has("hass")&&this.hass&&Ot.connect(this.hass),t.has("entityId")&&(this._schedules=Ot.getSchedulesForEntity(this.entityId))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!0,composed:!0}))}async _onTimerStart(t){const e=Ut(this.entityId,t.detail);await Ot.createSchedule(this.hass,e)}async _cancelSchedule(t){await Ot.cancelSchedule(this.hass,t)}render(){if(!this.open)return V;const t=this.hass?.language||"en";return q`
      <ha-dialog
        .open=${this.open}
        @closed=${this._close}
  ...
  `}function jt(t,e,i,s,o,r){return q`
    <hac-timer-dialog
      .hass=${t}
      .entityId=${e}
      .entityName=${i}
  ...
  `,t([pt({attribute:!1})],It.prototype,"hass",void 0),t([pt()],It.prototype,"entityId",void 0),t([pt()],It.prototype,"entityName",void 0),t([pt({type:Boolean})],It.prototype,"open",void 0),t([pt()],It.prototype,"defaultAction",void 0),t([ut()],It.prototype,"_schedules",void 0),It=t([lt("hac-timer-dialog")],It);const Rt=n`
  @keyframes spin {
...
`;let Ft=class extends at{constructor(){super(...arguments),this.icon="mdi:air-purifier",this.active=!1,this.animated=!0,this.animation="spin"}render(){const t=this.active&&this.animated?this.animation:"";return q`
  ...
  `],t([pt()],Ft.prototype,"icon",void 0),t([pt({type:Boolean})],Ft.prototype,"active",void 0),t([pt({type:Boolean})],Ft.prototype,"animated",void 0),t([pt()],Ft.prototype,"animation",void 0),Ft=t([lt("hac-shape-icon")],Ft);let qt=class extends at{constructor(){super(...arguments),this.primary="",this.secondary=""}render(){return q`
  ...
  `,t([pt()],qt.prototype,"primary",void 0),t([pt()],qt.prototype,"secondary",void 0),qt=t([lt("hac-state-info")],qt);let Bt=class extends at{render(){return q`
      <div class="container">
        <slot name="icon"></slot>
        <slot name="info"></slot>
      </div>
  ...
  `,Bt=t([lt("hac-state-item")],Bt);let Vt=class extends at{constructor(){super(...arguments),this.value=0,this.min=0,this.max=100,this.step=1,this.disabled=!1}_onChange(t){const e=t.target,i=Number(e.value);this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:i},bubbles:!0,composed:!0}))}render(){const t=(this.value-this.min)/(this.max-this.min)*100;return q`
  ...
  `,t([pt({type:Number})],Vt.prototype,"value",void 0),t([pt({type:Number})],Vt.prototype,"min",void 0),t([pt({type:Number})],Vt.prototype,"max",void 0),t([pt({type:Number})],Vt.prototype,"step",void 0),t([pt({type:Boolean})],Vt.prototype,"disabled",void 0),Vt=t([lt("hac-slider")],Vt);let Wt=class extends at{constructor(){super(...arguments),this.value=0,this.color="var(--primary-color)"}render(){const t=Math.min(100,Math.max(0,this.value));return q`
      <div class="bar">
  ...
  `,t([pt({type:Number})],Wt.prototype,"value",void 0),t([pt()],Wt.prototype,"color",void 0),Wt=t([lt("hac-progress-bar")],Wt);let Kt=class extends at{constructor(){super(...arguments),this.icon="",this.active=!1,this.label=""}_handleClick(){this.dispatchEvent(new CustomEvent("toggle",{bubbles:!0,composed:!0}))}render(){return q`
      <button
  ...
  `,t([pt()],Kt.prototype,"icon",void 0),t([pt({type:Boolean})],Kt.prototype,"active",void 0),t([pt()],Kt.prototype,"label",void 0),Kt=t([lt("hac-toggle-button")],Kt);const Xt=n`
  :host {
    display: block;
    --ha-space-6: 4px;
  }
...
`;function Jt(t,e){const i=t?.language||"en";return mt(`editor.${e.name}`,i)||e.name}function Zt(t,e){t.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}const Gt=[{name:"entity",required:!0,selector:{entity:{domain:"fan"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_toolbar",selector:{boolean:{}}},{name:"show_stats",selector:{boolean:{}}},{name:"show_settings",selector:{boolean:{}}},{name:"show_filter_info",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}],Qt=[{name:"pm25_entity",selector:{entity:{domain:"sensor"}}},{name:"temperature_entity",selector:{entity:{domain:"sensor"}}},{name:"humidity_entity",selector:{entity:{domain:"sensor"}}},{name:"motor_speed_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_life_entity",selector:{entity:{domain:"sensor"}}},{name:"filter_used_time_entity",selector:{entity:{domain:"sensor"}}},{name:"favorite_level_entity",selector:{entity:{domain:"number"}}},{name:"child_lock_entity",selector:{entity:{domain:"switch"}}},{name:"led_entity",selector:{entity:{}}},{name:"buzzer_entity",selector:{entity:{domain:"switch"}}}];let Yt=class extends at{constructor(){super(...arguments),this._expandedOverrides=!1,this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}_overrideValueChanged(t){Zt(this,{...this._config,...t.detail.value})}_toggleOverrides(){this._expandedOverrides=!this._expandedOverrides}render(){if(!this.hass||!this._config)return V;const t=this.hass.language||"en",e={show_name:!0,show_state:!0,show_toolbar:!0,show_stats:!0,show_settings:!0,show_filter_info:!0,compact_view:!1,icon_animation:!0,...this._config};return q`
  ...
  `}(this.hass,e,a):V}
          ...
          ${!c&&this._config.show_filter_info?function(t,e,i,s){const o=At(t,e),r=At(t,i);if(void 0===o&&void 0===r)return V;const n=o??0,a=(c=n)>50?"var(--green-color, #4caf50)":c>20?"var(--orange-color, #ff9800)":"var(--red-color, #f44336)";var c;return q`
  ...
  `}(this.hass,e.childLock,e.led,e.buzzer,a):V}
        ...
        ${this._config.show_timer?jt(this.hass,this._config.entity,s,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):V}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),r=e?kt(t):void 0,n=r?`${o} · ${r}`:o;return q`
      <div class="header">
  ...
  `}(this.hass,this._config.entity,e,!1!==this._config.icon_animation)}
        ${!1!==this._config.show_name||!1!==this._config.show_state?q`
            ...
            ></hac-state-info>
          `:V}
        ${this._config.show_timer?Dt(this._schedules,()=>{this._timerDialogOpen=!0}):V}
      </div>
    `}};te.styles=[ft,$t],t([pt({attribute:!1})],te.prototype,"hass",void 0),t([ut()],te.prototype,"_config",void 0),t([ut()],te.prototype,"_timerDialogOpen",void 0),t([ut()],te.prototype,"_schedules",void 0),te=t([lt(gt)],te);const ee="light-card",ie="light-card-editor",se=[yt,bt,n`
  /* Header */
  .header {
    display: flex;
    align-items: center;
...
`];function oe(t){return t.attributes.supported_color_modes||[]}function re(t){return"on"===t.state}function ne(t){const e=t.attributes.brightness;return null==e?re(t)?100:0:Math.max(1,Math.round(e/255*100))}function ae(t){const e=t/100;let i,s,o;return i=e<=66?255:329.698727446*Math.pow(e-60,-.1332047592),s=e<=66?99.4708025861*Math.log(e)-161.1195681661:288.1221695283*Math.pow(e-60,-.0755148492),o=e>=66?255:e<=19?0:138.5177312231*Math.log(e-10)-305.0447927307,[Math.round(Math.min(255,Math.max(0,i))),Math.round(Math.min(255,Math.max(0,s))),Math.round(Math.min(255,Math.max(0,o)))]}function ce(t,e,i,s,o,r){const n=r&&s?function(t){if(!re(t))return;const e=function(t){return t.attributes.rgb_color}(t);if(e)return`rgb(${e[0]}, ${e[1]}, ${e[2]})`;const i=t.attributes.color_temp_kelvin;if(i){const[t,e,s]=ae(i);return`rgb(${t}, ${e}, ${s})`}}(i):void 0;return q`
    <hac-shape-icon
      icon="mdi:lightbulb"
      ?active=${s}
      ?animated=${o}
      ...
      @click=${()=>Et(t,e)}
    ></hac-shape-icon>
  `}function le(t,e,i,s,o){const r=function(t,e){const i=[];for(let s=0;s<=5;s++){const o=t+s/5*(e-t),[r,n,a]=ae(o);i.push(`rgb(${r}, ${n}, ${a})`)}return`linear-gradient(to right, ${i.join(", ")})`}(s,o);return q`
    <div class="control-row">
      ...
      <hac-gradient-slider
        ...
        .step=${100}
        .gradient=${r}
        @value-changed=${i=>{const s=i.detail.value;zt(t,e,{color_temp_kelvin:s})}}
      ></hac-gradient-slider>
  ...
  `,t([pt({type:Number})],de.prototype,"value",void 0),t([pt({type:Number})],de.prototype,"min",void 0),t([pt({type:Number})],de.prototype,"max",void 0),t([pt({type:Number})],de.prototype,"step",void 0),t([pt({type:Boolean})],de.prototype,"disabled",void 0),t([pt()],de.prototype,"gradient",void 0),de=t([lt("hac-gradient-slider")],de);const pe=[{name:"entity",required:!0,selector:{entity:{domain:"light"}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_brightness_control",selector:{boolean:{}}},{name:"show_color_temp_control",selector:{boolean:{}}},{name:"show_color_control",selector:{boolean:{}}},{name:"use_light_color",selector:{boolean:{}}},{name:"icon_animation",selector:{boolean:{}}},{name:"compact_view",selector:{boolean:{}}},{name:"hide_controls_when_off",selector:{boolean:{}}},{name:"show_timer",selector:{boolean:{}}}]}];let ue=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}render(){if(!this.hass||!this._config)return V;const t={show_name:!0,show_state:!0,show_brightness_control:!0,show_color_temp_control:!0,show_color_control:!0,use_light_color:!0,icon_animation:!0,compact_view:!1,hide_controls_when_off:!0,...this._config};return q`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${pe}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}};ue.styles=Xt,t([pt({attribute:!1})],ue.prototype,"hass",void 0),t([ut()],ue.prototype,"_config",void 0),ue=t([lt(ie)],ue),Ct({type:ee,name:"Light Card",description:"Custom card for light entities with brightness and color controls"});let _e=class extends at{constructor(){super(...arguments),this._timerDialogOpen=!1,this._schedules=[],this._schedulerConnected=!1}disconnectedCallback(){super.disconnectedCallback(),this._schedulerUnsub?.()}static getConfigElement(){return document.createElement(ie)}static getStubConfig(t){const e=Object.keys(t.states).filter(t=>t.startsWith("light."));return{entity:e[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config={show_name:!0,show_state:!0,show_brightness_control:!0,show_color_temp_control:!0,show_color_control:!0,use_light_color:!0,icon_animation:!0,compact_view:!1,hide_controls_when_off:!0,...t}}getCardSize(){return this._config?.compact_view?1:3}shouldUpdate(t){if(t.has("_config")||t.has("_timerDialogOpen")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&this._config?.show_timer&&(this._schedulerConnected=!0,this._schedulerUnsub=Ot.subscribe(()=>{this._schedules=Ot.getSchedulesForEntity(this._config?.entity)}),Ot.connect(this.hass),this._schedules=Ot.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}render(){if(!this.hass||!this._config)return V;const t=this.hass.states[this._config.entity];if(!t)return q`
        <ha-card>
          <div class="not-found">Entity not found: ${this._config.entity}</div>
        </ha-card>
      `;const e=re(t),i=this._config.name||t.attributes.friendly_name||"Light",s=this._lang,o=this._config.compact_view;return q`
      <ha-card>
        <div class="container">
          ${this._renderHeader(t,e,i,s)}
          ${o||!e&&!1!==this._config.hide_controls_when_off?V:this._renderControls(t)}
        </div>
        ${this._config.show_timer?jt(this.hass,this._config.entity,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):V}
      </ha-card>
    `}_renderHeader(t,e,i,s){const o=mt(e?"state.on":"state.off",s),r=e?ne(t):0,n=e&&r?`${o} · ${r}%`:o;return q`
      <div class="header">
    ...
    <div class="control-row">
      ...
      <hac-slider
        ...
        .max=${100}
        .step=${1}
        @value-changed=${i=>{const s=i.detail.value;zt(t,e,{brightness_pct:s})}}
      ></hac-slider>
      <span class="value">${i}%</span>
    </div>
  `}(this.hass,e,ne(t)):V}
      ${!1!==this._config.show_color_temp_control&&function(t){return oe(t).includes("color_temp")}(t)?this._renderColorTemp(t,e):V}
      ${!1!==this._config.show_color_control&&function(t){const e=["hs","xy","rgb","rgbw","rgbww"];return oe(t).some(t=>e.includes(t))}(t)?he(this.hass,e,function(t){return t.attributes.hs_color}(t)?.[0]??0):V}
    `}_renderColorTemp(t,e){const{min:i,max:s}=function(t){return{min:t.attributes.min_color_temp_kelvin??2e3,max:t.attributes.max_color_temp_kelvin??6500}}(t);return le(this.hass,e,function(t){return t.attributes.color_temp_kelvin??4e3}(t),i,s)}};_e.styles=[ft,se],t([pt({attribute:!1})],_e.prototype,"hass",void 0),t([ut()],_e.prototype,"_config",void 0),t([ut()],_e.prototype,"_timerDialogOpen",void 0),t([ut()],_e.prototype,"_schedules",void 0),_e=t([lt(ee)],_e);const me="hac-timer-card",fe="hac-timer-card-editor",ge=[bt,n`
  .header {
    display: flex;
    align-items: center;
    gap: 12px;
...
`],ve=[{name:"entity",required:!0,selector:{entity:{}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"show_name",selector:{boolean:{}}},{name:"show_state",selector:{boolean:{}}},{name:"show_presets",selector:{boolean:{}}}]},{name:"default_action",selector:{select:{options:[{value:"turn_off",label:"Turn Off"},{value:"turn_on",label:"Turn On"},{value:"toggle",label:"Toggle"}]}}}];let ye=class extends at{constructor(){super(...arguments),this._computeLabel=t=>Jt(this.hass,t)}setConfig(t){this._config=t}_valueChanged(t){Zt(this,t.detail.value)}render(){if(!this.hass||!this._config)return V;const t={show_name:!0,show_state:!0,show_presets:!0,default_action:"turn_off",...this._config};return q`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${ve}
        ...
        @value-changed=${this._valueChanged}
      ></ha-form>
    `}};ye.styles=Xt,t([pt({attribute:!1})],ye.prototype,"hass",void 0),t([ut()],ye.prototype,"_config",void 0),ye=t([lt(fe)],ye),Ct({type:me,name:"Timer Card",description:"Schedule on/off timers for any entity"});let be=class extends at{constructor(){super(...arguments),this._schedules=[],this._schedulerConnected=!1}static getConfigElement(){return document.createElement(fe)}static getStubConfig(t){return{entity:Object.keys(t.states)[0]||""}}setConfig(t){if(!t.entity)throw new Error("Entity is required");this._config={show_name:!0,show_state:!0,default_action:"turn_off",show_presets:!0,...t}}getCardSize(){return 4}connectedCallback(){super.connectedCallback(),this._unsubscribe=Ot.subscribe(()=>{this._schedules=Ot.getSchedulesForEntity(this._config?.entity)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}shouldUpdate(t){if(t.has("_config")||t.has("_schedules"))return!0;if(!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]}updated(t){t.has("hass")&&this.hass&&!this._schedulerConnected&&(this._schedulerConnected=!0,Ot.connect(this.hass),this._schedules=Ot.getSchedulesForEntity(this._config.entity))}get _lang(){return this.hass?.language||"en"}_togglePower(){Et(this.hass,this._config.entity)}async _onTimerStart(t){const e=Ut(this._config.entity,t.detail);"custom"===t.detail.action&&this._config.custom_service&&(e.service=this._config.custom_service,e.service_data=this._config.custom_service_data),await Ot.createSchedule(this.hass,e)}async _cancelSchedule(t){await Ot.cancelSchedule(this.hass,t)}render(){if(!this.hass||!this._config)return V;const t=this.hass.states[this._config.entity];if(!t)return q`
        <ha-card>
          <div class="not-found">
    ...
    `}_renderHeader(t,e,i,s,o){const r=this._schedules.length>0?this._schedules[0]:null;let n=s;if(r){n=`${s} · ${Tt(r.action,o)}`}return q`
      <div class="header">
        <button
