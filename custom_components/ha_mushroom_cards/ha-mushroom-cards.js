...
`];function wt(t,e){if(!t.entities)return[];const i=t.entities[e];if(!i?.device_id)return[];const s=i.device_id;return Object.values(t.entities).filter(t=>t.device_id===s).map(t=>t.entity_id)}function xt(t,e,i,s){const o=i.endsWith(".")?i:i+".",n=e.filter(e=>e.startsWith(o)&&t.states[e]);if(0===n.length)return;if(!s)return n[0];const{deviceClass:r,keywords:a}=s,c=e=>!!r&&t.states[e]?.attributes.device_class===r,l=t=>!(!a||0===a.length)&&a.some(e=>t.includes(e)),h=n.find(t=>c(t)&&l(t));if(h)return h;const d=n.find(t=>c(t));if(d)return d;const u=n.find(t=>l(t));return u||void 0}function kt(t){return t.attributes.preset_mode}function Ct(t,e){const i=function(t,e){if(!e)return;const i=t.states[e];return i&&"unavailable"!==i.state&&"unknown"!==i.state?i.state:void 0}(t,e);if(void 0===i)return;const s=parseFloat(i);return isNaN(s)?void 0:s}function St(t){const e=window;e.customCards=e.customCards||[],e.customCards.some(e=>e.type===t.type)||e.customCards.push(t)}function Et(t,e,i,s,o){t.callService(e,i,{entity_id:s,...o})}function At(t,e){Et(t,e.split(".")[0],"toggle",e)}function Ot(t,e,i){Et(t,e.split(".")[0],"turn_on",e,i)}function zt(t,e,i,s,o){if(0===i.length)return q;const n=i=>{o||Ot(t,e),function(t,e,i){Et(t,"fan","set_preset_mode",e,{preset_mode:i})}(t,e,i)};return B`
  ...
  `,t([ut()],Ut.prototype,"lang",void 0),t([ut({type:Array})],Ut.prototype,"presets",void 0),t([ut()],Ut.prototype,"action",void 0),t([ut({type:Boolean})],Ut.prototype,"disabled",void 0),t([pt()],Ut.prototype,"_mode",void 0),t([pt()],Ut.prototype,"_hours",void 0),t([pt()],Ut.prototype,"_minutes",void 0),t([pt()],Ut.prototype,"_timeValue",void 0),t([pt()],Ut.prototype,"_selectedAction",void 0),Ut=t([lt("hac-timer-picker")],Ut);let Nt=class extends at{constructor(){super(...arguments),this.compact=!1,this._remaining=""}connectedCallback(){super.connectedCallback(),this._updateCountdown(),this._interval=setInterval(()=>this._updateCountdown(),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._interval&&(clearInterval(this._interval),this._interval=void 0)}updated(t){t.has("schedule")&&this._updateCountdown()}_updateCountdown(){if(!this.schedule)return;const t=Date.now(),e=new Date(this.schedule.trigger_at).getTime(),i=Math.max(0,e-t);if(0===i)return this._remaining="00:00",void(this._interval&&(clearInterval(this._interval),this._interval=void 0));const s=Math.floor(i/1e3),o=Math.floor(s/3600),n=Math.floor(s%3600/60),r=s%60,a=t=>String(t).padStart(2,"0");this._remaining=o>0?`${a(o)}:${a(n)}:${a(r)}`:`${a(n)}:${a(r)}`}get _actionClass(){switch(this.schedule?.action){case"turn_on":return"action-on";case"turn_off":return"action-off";case"toggle":return"action-toggle";default:return""}}_cancel(){this.dispatchEvent(new CustomEvent("timer-cancel",{detail:{scheduleId:this.schedule.id},bubbles:!0,composed:!0}))}render(){return this.compact?B`
  ...
  `,t([ut({attribute:!1})],Nt.prototype,"schedule",void 0),t([ut({type:Boolean})],Nt.prototype,"compact",void 0),t([pt()],Nt.prototype,"_remaining",void 0),Nt=t([lt("hac-timer-badge")],Nt);let Dt=class extends at{constructor(){super(...arguments),this.entityId="",this.entityName="",this.open=!1,this.defaultAction="turn_off",this._schedules=[]}get _primaryEntityId(){return Array.isArray(this.entityId)?this.entityId[0]:this.entityId}connectedCallback(){super.connectedCallback(),this._unsubscribe=Pt.subscribe(()=>{this._schedules=Pt.getSchedulesForEntity(this._primaryEntityId)})}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe?.()}updated(t){t.has("hass")&&this.hass&&Pt.connect(this.hass),t.has("entityId")&&(this._schedules=Pt.getSchedulesForEntity(this._primaryEntityId))}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("dialog-closed",{bubbles:!0,composed:!0}))}async _onTimerStart(t){const e=Array.isArray(this.entityId)&&this.entityId.length>1?function(t,e){const i=t[0].split(".")[0],s={target_entity:t[0],action:"custom",service:`${i}.${e.action}`,service_data:{entity_id:t}};return e.duration?s.duration=e.duration:e.time&&(s.time=e.time),s}(this.entityId,t.detail):Tt(this._primaryEntityId,t.detail);await Pt.createSchedule(this.hass,e)}async _cancelSchedule(t){await Pt.cancelSchedule(this.hass,t)}render(){if(!this.open)return q;const t=this.hass?.language||"en";return B`
    ...
    `}};function Ht(t,e){const i=t.length>0;return B`
    <div class="timer-control">
      <button class="timer-btn ${i?"active":""}" @click=${e}>
        <ha-icon icon="mdi:timer-outline"></ha-icon>
      </button>
      ${i?t.map(t=>B`<hac-timer-badge .schedule=${t} compact></hac-timer-badge>`):q}
    </div>
  ...
  `,t([ut({attribute:!1})],Dt.prototype,"hass",void 0),t([ut({attribute:!1})],Dt.prototype,"entityId",void 0),t([ut()],Dt.prototype,"entityName",void 0),t([ut({type:Boolean})],Dt.prototype,"open",void 0),t([ut()],Dt.prototype,"defaultAction",void 0),t([pt()],Dt.prototype,"_schedules",void 0),Dt=t([lt("hac-timer-dialog")],Dt);const jt=r`
  @keyframes spin {
...
`];function Ee(t,e){return e.map(e=>{const i=wt(t,e),s=t.states[e];return{entityId:e,name:s?.attributes.friendly_name||e,power:xt(t,i,"sensor",{deviceClass:"power"}),dailyConsumption:xt(t,i,"sensor",{keywords:["daily"]}),monthlyConsumption:xt(t,i,"sensor",{keywords:["monthly"]}),yearlyConsumption:xt(t,i,"sensor",{keywords:["yearly"]}),childLock:xt(t,i,"switch",{keywords:["child_lock","physical_control_locked"]}),powerOnBehavior:xt(t,i,"select",{keywords:["power_on"]})}})}function Ae(t,e){if(!e)return;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return;const s=parseFloat(i.state);return isNaN(s)?void 0:s}function Oe(t,e){if(!e)return"";const i=t.states[e];return i?.attributes.unit_of_measurement||""}function ze(t,e,i){let s=0,o=!1;for(const n of e){const e=n[i];if(!e)continue;const r=Ae(t,e);void 0!==r&&(s+=r,o=!0)}return o?s:void 0}function Me(t,e){return e.some(e=>"on"===t.states[e]?.state)}function Pe(t,e,i,s){const o=[{key:"power",labelKey:"stats.power",configKey:"show_power"},{key:"dailyConsumption",labelKey:"stats.daily",decimals:2,configKey:"show_daily_consumption"},{key:"monthlyConsumption",labelKey:"stats.monthly",decimals:2,configKey:"show_monthly_consumption"},{key:"yearlyConsumption",labelKey:"stats.yearly",decimals:2,configKey:"show_yearly_consumption"}].filter(i=>!1!==s[i.configKey]&&void 0!==ze(t,e,i.key));return 0===o.length?q:B`
  ...
  `}(this.hass,t,s)}
        ...
        ${this._config.show_timer?Rt(this.hass,this._config.entities,i,this._timerDialogOpen,this._config.timer_default_action||"turn_off",()=>{this._timerDialogOpen=!1}):q}
      </ha-card>
    ...
    `}};Ie.styles=[gt,Se],t([ut({attribute:!1})],Ie.prototype,"hass",void 0),t([pt()],Ie.prototype,"_config",void 0),t([pt()],Ie.prototype,"_timerDialogOpen",void 0),t([pt()],Ie.prototype,"_schedules",void 0),Ie=t([lt(ke)],Ie);const Ue="hac-timer-card",Ne="hac-timer-card-editor",De=[bt,r`
  .header {
    display: flex;
    align-items: center;
    gap: 12px;
